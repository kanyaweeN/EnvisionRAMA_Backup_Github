...
namespace EnvisionBreastControl.Helper
{
    /// <summary>
    ...
    {
        public static double Dip { get { return 1 / 96; } }
        /// <summary>
        ...
        {
            PresentationSource source = System.Windows.PresentationSource.FromVisual(System.Windows.Application.Current.MainWindow);
