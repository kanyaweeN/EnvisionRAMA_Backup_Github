...
namespace Envision.BusinessLogic
{
    public interface IPatientDemographic {
        ...
        bool ISAllergy { get; set; }
        DataTable AllergyData { get; set; }
        bool HasEngName { get; set; }
        string PATIENT_ID_LABEL { get; set; }
        string PATIENT_ID_DETAIL { get; set; }
        string NON_RESIDENCE { get; set; }
    }
}
