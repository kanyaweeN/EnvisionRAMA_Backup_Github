...
namespace Envision.Plugin.CRFile {
    ...
    public class rptOrderAllAIMC : ReportClass {
        
        public rptOrderAllAIMC() {
        }
        
        public override string ResourceName {
            get {
                return "rptOrderAllAIMC.rpt";
            }
            set {
                // Do nothing
            }
        ...
        public override string FullResourceName {
            get {
                return "Envision.Plugin.CRFile.rptOrderAllAIMC.rpt";
            }
            set {
                // Do nothing
            }
        ...
        [Browsable(false)]
        [DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)]
        public CrystalDecisions.Shared.IParameterField Parameter_UNIT_ID {
            get {
    ...
    public class CachedrptOrderAllAIMC : Component, ICachedReport {
        
        public CachedrptOrderAllAIMC() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            rptOrderAllAIMC rpt = new rptOrderAllAIMC();
            rpt.Site = this.Site;
            return rpt;
        }
