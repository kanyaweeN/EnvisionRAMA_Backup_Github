...
namespace Envision.Plugin.CRFile {
    ...
    public class rptAppointAIMC : ReportClass {
        
        public rptAppointAIMC() {
        }
        
        public override string ResourceName {
            get {
                return "rptAppointAIMC.rpt";
            }
            set {
                // Do nothing
            }
        ...
        public override string FullResourceName {
            get {
                return "Envision.Plugin.CRFile.rptAppointAIMC.rpt";
            }
            set {
                // Do nothing
            }
    ...
    public class CachedrptAppointAIMC : Component, ICachedReport {
        
        public CachedrptAppointAIMC() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            rptAppointAIMC rpt = new rptAppointAIMC();
            rpt.Site = this.Site;
            return rpt;
        }
