...
namespace Envision.Plugin.XtraFile.xtraReports
{
    public partial class xrptScheduleReport : DevExpress.XtraReports.UI.XtraReport
    {
        ...
        public xrptScheduleReport()
        {
            InitializeComponent();
            this.PrintingSystem.ShowMarginsWarning = false;

        }
        public xrptScheduleReport(int _schedule_id)
        {
        ...
        public xrptScheduleReport(DataSet ds)
        {
            InitializeComponent();
            this.PrintingSystem.ShowMarginsWarning = false;
            dsTemp = new DataSet();
        ...
        private void bindingData(DataSet ds)
        {
            ...
            lblAppointDt.Text = "วัน" + Convert.ToDateTime(ds.Tables[1].Rows[0]["APPOINT_DT"]).ToString("dddd d MMMM yyyy เวลา HH:mm", CultureInfo.GetCultureInfo("th-TH").DateTimeFormat);
