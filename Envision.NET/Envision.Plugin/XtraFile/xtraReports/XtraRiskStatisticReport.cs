...
{
    public partial class XtraRiskStatisticReport : DevExpress.XtraReports.UI.XtraReport
    {
        private DataSet dsReport;
        private DateTime from;
        private DateTime to;
        public XtraRiskStatisticReport(DataSet report, DateTime from, DateTime to)
        {
        ...
        public XtraRiskStatisticReport()
