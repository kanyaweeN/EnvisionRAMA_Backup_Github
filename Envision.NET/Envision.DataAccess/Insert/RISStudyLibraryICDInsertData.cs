...
{
	public class RISStudyLibraryICDInsertData : DataAccessBase 
	{
        public RIS_STUDYLIBRARY RIS_STUDYLIBRARY { get; set; }
        public RISStudyLibraryICDInsertData()
		{
            RIS_STUDYLIBRARY = new RIS_STUDYLIBRARY();
            StoredProcedureName = StoredProcedure.Prc_RIS_STUDYLIBRARYICD_Insert;
		}
		public DataSet Add()
		{
        ...
        private DbParameter[] buildParameter()
        {
            DbParameter[] parameters ={
                ...
                Parameter("@ICD_ID",RIS_STUDYLIBRARY.ICD_ID),
