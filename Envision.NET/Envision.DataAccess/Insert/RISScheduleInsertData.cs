...
namespace Envision.DataAccess.Insert
{
	public class RISScheduleInsertData : DataAccessBase 
	{
        ...
        public RISScheduleInsertData()
		{
            ...
            StoredProcedureName = StoredProcedure.Prc_RIS_SCHEDULE_Insert;
		}
        ...
        {
            ParameterList = buildParameter();
            StoredProcedureName = StoredProcedure.Prc_RIS_SCHEDULE_Insert_FromRama;
            DataSet ds = new DataSet();
            ds = ExecuteDataSet2();
            RIS_SCHEDULE.SCHEDULE_ID = Convert.ToInt32(ParameterList[0].Value);
        }
        ...
        {
            ParameterList = buildParameterComments();
            StoredProcedureName = StoredProcedure.Prc_RIS_SCHEDULE_InsertComments;
            DataSet ds = new DataSet();
            ds = ExecuteDataSet();
            RIS_SCHEDULE.SCHEDULE_ID = Convert.ToInt32(ParameterList[0].Value);
        }
        ...
        public int AddReservation()
        {
            ...
            StoredProcedureName = StoredProcedure.Prc_RIS_SCHEDULE_RESERVATION_Insert;
            DataSet ds = new DataSet();
            ds = ExecuteDataSet();
        ...
        private DbParameter[] buildParameterComments()
        {
            DbParameter Appoint_DT = Parameter();
            Appoint_DT.ParameterName = "@START_DATETIME";
            if (RIS_SCHEDULE.START_DATETIME == null)
