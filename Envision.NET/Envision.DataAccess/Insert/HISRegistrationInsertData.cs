	...
	public class HISRegistrationInsertData : DataAccessBase 
	{
        ...
        public HISRegistrationInsertData(bool linkdown)
        {
            ...
            else
            {
                ...
                //StoredProcedureName = StoredProcedure.Prc_HIS_REGISTRATION_InsertOrUpdateFromHIS_TEST;
                action = 2;
            }
        }
        ...
        public int AddCNMI()
        {
            ...
            try
            {
                ...
                {
                    //StoredProcedureName = StoredProcedure.Prc_HIS_REGISTRATION_InsertOrUpdateFromHIS_FromRama;
                    ParameterList = buildParameterLinkdown();
                    ExecuteNonQuery2();
                    retValue = (int)ParameterList[0].Value; ;
                }
        ...
        public int AddCNMI(DbTransaction tran)
        {
            HIS_REGISTRATION = new HIS_REGISTRATION();
            StoredProcedureName = StoredProcedure.Prc_HIS_REGISTRATION_Insert;
            ParameterList = buildParameter();
        ...
        private DbParameter[] buildParameterInsertOrUpdate()
        {
            ...
            DbParameter pCREATED_BY = Parameter("@CREATED_BY", HIS_REGISTRATION.CREATED_BY);
            DbParameter pIS_JOHNDOE = Parameter("@IS_JOHNDOE", HIS_REGISTRATION.IS_JOHNDOE);
            DbParameter pIS_FOREIGNER = Parameter("@IS_FOREIGNER", HIS_REGISTRATION.IS_FOREIGNER);
            DbParameter pPATIENT_ID_LABEL = Parameter("@PATIENT_ID_LABEL", HIS_REGISTRATION.PATIENT_ID_LABEL);
            DbParameter pPATIENT_ID_DETAIL = Parameter("@PATIENT_ID_DETAIL", HIS_REGISTRATION.PATIENT_ID_DETAIL);
        ...
        public int AddFromADTChange(int presentRegId)
        {
            try
            {
                StoredProcedureName = StoredProcedure.Prc_HIS_REGISTRATION_InsertOrUpdateADTChange;
                ParameterList = buildParameterInsertOrUpdateADTChange(presentRegId);
                ExecuteNonQuery();
                return (int)ParameterList[0].Value;
            }
            catch { }
        ...
        private DbParameter[] buildParameterInsertOrUpdateADTChange(int PRESENT_REG_ID)
        {
            DbParameter pREG_ID = Parameter("@REG_ID", HIS_REGISTRATION.REG_ID);
            pREG_ID.Direction = ParameterDirection.Output;
            DbParameter pHN = Parameter("@HN", HIS_REGISTRATION.HN);
            ...
            DbParameter[] parameters ={
                    ...
                    ,pCREATED_BY
                    //,pIS_JOHNDOE
                    ,Parameter("@PRESENT_REG_ID",PRESENT_REG_ID)
                   // ,pSHN
            };
            return parameters;
        }
