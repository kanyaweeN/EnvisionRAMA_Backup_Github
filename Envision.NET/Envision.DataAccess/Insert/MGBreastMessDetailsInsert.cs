...
{
    public class MGBreastMessDetailsInsert : DataAccessBase
    {
        public MG_BREASTMASSDETAILS MG_BREASTMASSDETAILS { get; set; }
        public DbTransaction Trans { get; set; }
        public MGBreastMessDetailsInsert()
        {
            this.StoredProcedureName = StoredProcedure.Prc_MG_BREASTMASSDETAILS_INSERT;
        }
        ...
        private DbParameter[] BuildParameters()
        {
            DbParameter[] parameters = { 
                                            ...
                                            Parameter("@FINDING_TYPE", this.MG_BREASTMASSDETAILS.FINDING_TYPE),
                                            ...
                                            Parameter("@CREATED_BY", this.MG_BREASTMASSDETAILS.CREATED_BY),
