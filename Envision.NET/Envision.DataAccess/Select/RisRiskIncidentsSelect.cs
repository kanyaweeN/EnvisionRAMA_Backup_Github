...
namespace Envision.DataAccess.Select
{
    public class RisRiskIncidentsSelect : DataAccessBase
    {
        ...
        {
            this.StoredProcedureName = StoredProcedure.Prc_RIS_RISKINCIDENTS_SELECTbyOrderID;
            ParameterList = this.BuildParametersByOrderID();
            return ExecuteDataTable();
        }
        private DbParameter[] BuildParametersByOrderID()
        {
