namespace Envision.DataAccess
{
    ...
    public class DataAccessBase
    {
        ...
        protected int ExecuteNonQuery2()
        {
            DbCommand cmd = coreSQL.createCommand();
            int row = -1;
            if (Transaction == null)
            {
                using (DbConnection conn = coreSQL.createConnection2())
                {
                    cmd.CommandText = StoredProcedureName.ToString();
                    cmd.CommandType = CommandType.StoredProcedure;
                    cmd.Connection = conn;
        ...
        protected DataSet ExecuteDataSet2()
        {
            DataSet ds = null;
            DbCommand cmd = coreSQL.createCommand();
            if (Transaction == null)
        ...
        protected DataSet ExecuteDataSetReportSearch2()
        {
            DataSet ds = null;
            DbCommand cmd = coreSQL.createCommand();
            if (Transaction == null)
            {
                using (DbConnection conn = coreSQL.createConnectionReportSearch2())
                {
                    cmd.CommandText = StoredProcedureName.ToString();
                    cmd.CommandType = CommandType.StoredProcedure;
                    cmd.Connection = conn;
...
namespace Envision.CoreSQL
{
    ...
    class EnvisionSQL {
        ...
        public EnvisionSQL()
        {
            ...
            connectionString2 = ConfigurationSettings.AppSettings["connStr2"];
        }
        ...
        {
            SqlConnection conn =
                new SqlConnection(ConfigurationSettings.AppSettings["connStrReportSearch"]);
            return conn;
        }
        public DbConnection createConnection2()
        {
            SqlConnection conn =
                new SqlConnection(ConfigurationSettings.AppSettings["connStr2"]);
            return conn;
        }
        public DbConnection createConnectionReportSearch2()
        {
            SqlConnection conn =
                new SqlConnection(ConfigurationSettings.AppSettings["connStrReportSearch2"]);
            return conn;
        }
    }
}
