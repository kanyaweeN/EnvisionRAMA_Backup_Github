...
namespace Envision.DataAccess.Update
{
	public class MISBiopsyresultUpdateData : DataAccessBase 
	{
		...
		public  MISBiopsyresultUpdateData()
		{
			...
			StoredProcedureName = StoredProcedure.Prc_MIS_BIOPSYRESULT_Update;
		}
		public bool Update()
		{
        ...
        private DbParameter[] buildParameter()
        {
            ...
            if (MIS_BIOPSYRESULT.LOC_NO_R == null)
            ...
            if (MIS_BIOPSYRESULT.LOC_NO_L == null)
            ...
            if (MIS_BIOPSYRESULT.DEPTH_TYPE_R == null)
                Depth_R.Value = DBNull.Value;
            else
                Depth_R.Value = MIS_BIOPSYRESULT.DEPTH_TYPE_R.ToString() == "N" ? (object)DBNull.Value : MIS_BIOPSYRESULT.DEPTH_TYPE_R;

            DbParameter Depth_L = Parameter();
            Depth_L.ParameterName = "@DEPTH_TYPE_L";
            if (MIS_BIOPSYRESULT.DEPTH_TYPE_L == null)
                Depth_L.Value = DBNull.Value;
            else
                Depth_L.Value = MIS_BIOPSYRESULT.DEPTH_TYPE_L.ToString() == "N" ? (object)DBNull.Value : MIS_BIOPSYRESULT.DEPTH_TYPE_L;
