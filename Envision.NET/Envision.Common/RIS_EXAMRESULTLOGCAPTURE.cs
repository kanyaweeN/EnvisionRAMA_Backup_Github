...
{
    [Table(Name = "dbo.RIS_EXAMRESULTLOGCAPTURE")]
    public partial class RIS_EXAMRESULTLOGCAPTURE : INotifyPropertyChanging, INotifyPropertyChanged
    {
        ...
        public RIS_EXAMRESULTLOGCAPTURE()
        {
            OnCreated();
        }
