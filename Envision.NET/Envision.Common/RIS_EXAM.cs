...
namespace Envision.Common
{
    ...
    public partial class RIS_EXAM : INotifyPropertyChanging, INotifyPropertyChanged
    {
        ...
        private char _STAT_FLAG;
        private char _URGENT_FLAG;


        public char STAT_FLAG
        {
            get { return _STAT_FLAG; }
            set { _STAT_FLAG = value; }
        }

        public char URGENT_FLAG
        {
            get { return _URGENT_FLAG; }
            set { _URGENT_FLAG = value; }
        }
