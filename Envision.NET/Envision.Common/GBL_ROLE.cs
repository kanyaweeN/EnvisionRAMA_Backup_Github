...
{
    [Table(Name = "dbo.GBL_ROLE")]
    public partial class GBL_ROLE : INotifyPropertyChanging, INotifyPropertyChanged
    {
        ...
        partial void OnROLE_UIDChanging(string value);
        ...
        [Column(Storage = "_ROLE_ID", AutoSync = AutoSync.OnInsert, DbType = "Int NOT NULL IDENTITY", IsPrimaryKey = true, IsDbGenerated = true)]
        public int ROLE_ID
        {
            get
            {
        ...
        [Association(Name = "GBL_ROLE_GBL_GRANTROLE", Storage = "_GBL_GRANTROLEs", ThisKey = "ROLE_ID", OtherKey = "ROLE_ID")]
        ...
        [Association(Name = "GBL_ENV_GBL_ROLE", Storage = "_GBL_ENV", ThisKey = "ORG_ID", OtherKey = "ORG_ID", IsForeignKey = true)]
            ...
            set
            {
                            ...
                            || (this._GBL_ENV.HasLoadedOrAssignedValue == false)))
                {
                    ...
                    if ((previousValue != null))
                    {
                        ...
                        previousValue.GBL_ROLEs.Remove(this);
                    }
                    this._GBL_ENV.Entity = value;
                    if ((value != null))
                    {
                        value.GBL_ROLEs.Add(this);
        ...
        public string RoleDTLId { get; set; }
