...
{
    public partial class OperatorNote : Envision.NET.Forms.Main.MasterForm  // Form
    {
        ...
        private void SelectTemplateToGrid(int ExamID)
        {
            ...
            process.RIS_OPNOTEITEMTEMPLATE = new Envision.Common.RIS_OPNOTEITEMTEMPLATE();
            process.RIS_OPNOTEITEMTEMPLATE.EXAM_ID = ExamID;
            process.RIS_OPNOTEITEMTEMPLATE.LAST_MODIFIED_BY = Convert.ToInt32(TempID);

            #region Pre-Op
            process.RIS_OPNOTEITEMTEMPLATE.OPNOTE_TYPE = 'B';
            process.Invoke();
            ...
            #region Post-Op
            process.RIS_OPNOTEITEMTEMPLATE.OPNOTE_TYPE = 'A';
            process.Invoke();
            ...
            #region PostCon-Op
            process.RIS_OPNOTEITEMTEMPLATE.OPNOTE_TYPE = 'C';
            process.Invoke();
            ...
            PostTemplateC.Columns["CHK"].Name = "";
        ...
        private void SelectItemToGrid()
        {
            ...
            process.RIS_OPNOTEITEM = new Envision.Common.RIS_OPNOTEITEM();
            process.RIS_OPNOTEITEM.OP_ITEM_ID = -100;
            process.Invoke();
        ...
        private void btnLookUpHN_Click(object sender, EventArgs e)
        {
            ...
            lv.ValueUpdated += new ValueUpdatedEventHandler(HN_ValueUpdated);
...
//            string con = "";
            ...
            lv.Data = lvs.SelectOPNoteHN("").Tables[0];
            lv.Show();
        }
        private void HN_ValueUpdated(object sender, Envision.NET.Forms.Dialog.ValueUpdatedEventArgs e)
        {
            ...
            LookUpSelect lvs = new LookUpSelect();
            LookupData lv = new LookupData();
            lv.ValueUpdated += new ValueUpdatedEventHandler(Exam_ValueUpdated);
...
//            qry = string.Format(qry, TempID);
            ...
            lv.Data = lvs.SelectOPNoteExam(Convert.ToInt32(TempID)).Tables[0];
            lv.Show();
        }
        ...
        private void Save()
        {
            ...
            try
            {
                ...
                ProcessAddRISOpnoteitemtemplate prcAdd = new ProcessAddRISOpnoteitemtemplate();
                ProcessDeleteRISOpnoteitemtemplate prcDel = new ProcessDeleteRISOpnoteitemtemplate();

                switch (xtraTabControl1.SelectedTabPageIndex)
                {
                    case 0:
                        prcDel.RIS_OPNOTEITEMTEMPLATE.OP_ITEM_ID = 0;
                        prcDel.RIS_OPNOTEITEMTEMPLATE.EXAM_ID = Convert.ToInt32(textExamName.Tag.ToString());
                        prcDel.RIS_OPNOTEITEMTEMPLATE.OPNOTE_TYPE = 'B';
                        prcDel.RIS_OPNOTEITEMTEMPLATE.LAST_MODIFIED_BY = new GBLEnvVariable().UserID;
                        prcDel.Invoke();

                        DataTable dtPre = (DataTable)grdPreTemplate.DataSource;
                        foreach (DataRow dr in dtPre.Rows)
                        {
                            prcAdd.RIS_OPNOTEITEMTEMPLATE.OP_ITEM_ID = Convert.ToInt32(dr["OP_ITEM_ID"].ToString());
                            prcAdd.RIS_OPNOTEITEMTEMPLATE.EXAM_ID = Convert.ToInt32(textExamName.Tag.ToString());
                            prcAdd.RIS_OPNOTEITEMTEMPLATE.ITEM_VALUE = dr["ITEM_VALUE"].ToString();
                            prcAdd.RIS_OPNOTEITEMTEMPLATE.ITEM_UNIT = dr["ITEM_UNIT"].ToString();
                            prcAdd.RIS_OPNOTEITEMTEMPLATE.OPNOTE_TYPE = 'B';
                            prcAdd.RIS_OPNOTEITEMTEMPLATE.CREATED_BY = new GBLEnvVariable().UserID;
                            prcAdd.RIS_OPNOTEITEMTEMPLATE.LAST_MODIFIED_BY = prcAdd.RIS_OPNOTEITEMTEMPLATE.CREATED_BY;
                    ...
                    case 1:
                        prcDel.RIS_OPNOTEITEMTEMPLATE.OP_ITEM_ID = 0;
                        prcDel.RIS_OPNOTEITEMTEMPLATE.EXAM_ID = Convert.ToInt32(textExamName.Tag.ToString());
                        prcDel.RIS_OPNOTEITEMTEMPLATE.OPNOTE_TYPE = 'A';
                        prcDel.RIS_OPNOTEITEMTEMPLATE.LAST_MODIFIED_BY = new GBLEnvVariable().UserID;
                        prcDel.Invoke();
                        ...
                        foreach (DataRow dr in dtPost.Rows)
                        {
                            ...
                            prcAdd.RIS_OPNOTEITEMTEMPLATE.ITEM_VALUE = dr["ITEM_VALUE"].ToString();
                            prcAdd.RIS_OPNOTEITEMTEMPLATE.ITEM_UNIT = dr["ITEM_UNIT"].ToString();
                            prcAdd.RIS_OPNOTEITEMTEMPLATE.OPNOTE_TYPE = 'A';
                            prcAdd.RIS_OPNOTEITEMTEMPLATE.CREATED_BY = new GBLEnvVariable().UserID;
                            prcAdd.RIS_OPNOTEITEMTEMPLATE.LAST_MODIFIED_BY = prcAdd.RIS_OPNOTEITEMTEMPLATE.CREATED_BY;
                        ...
                        prcDel.RIS_OPNOTEITEMTEMPLATE.OP_ITEM_ID = 0;
                        prcDel.RIS_OPNOTEITEMTEMPLATE.EXAM_ID = Convert.ToInt32(textExamName.Tag.ToString());
                        prcDel.RIS_OPNOTEITEMTEMPLATE.OPNOTE_TYPE = 'C';
                        prcDel.RIS_OPNOTEITEMTEMPLATE.LAST_MODIFIED_BY = new GBLEnvVariable().UserID;
                        prcDel.Invoke();
                        ...
                        foreach (DataRow dr in dtPostC.Rows)
                        {
                            ...
                            prcAdd.RIS_OPNOTEITEMTEMPLATE.ITEM_VALUE = dr["ITEM_VALUE"].ToString();
                            prcAdd.RIS_OPNOTEITEMTEMPLATE.ITEM_UNIT = dr["ITEM_UNIT"].ToString();
                            prcAdd.RIS_OPNOTEITEMTEMPLATE.OPNOTE_TYPE = 'C';
                            prcAdd.RIS_OPNOTEITEMTEMPLATE.CREATED_BY = new GBLEnvVariable().UserID;
                            prcAdd.RIS_OPNOTEITEMTEMPLATE.LAST_MODIFIED_BY = prcAdd.RIS_OPNOTEITEMTEMPLATE.CREATED_BY;
        ...
        private void btnAlergy_Click(object sender, EventArgs e)
        {
            ...
            if (textHN.Text.Length > 0)
            {
                DataSet dsHIS = HIS_p.Get_Adr(textHN.Text);
            ...
            else if ((int)e.KeyChar == 13)
            {
                if (textHN.Text.Trim().Length > 0)
                {
                    ...
                    if (dsHN.Tables[0].Rows.Count > 0)
                    {
                        ...
                        LookupData lv = new LookupData();
                        lv.ValueUpdated += new ValueUpdatedEventHandler(Exam_Clicks);
        ...
        private void Exam_Clicks(object sender, Envision.NET.Forms.Dialog.ValueUpdatedEventArgs e)
        {
            string[] retValue = e.NewValue.Split(new Char[] { '^' });
            textHN.Text = TempHN;
            textName.Text = TempName;
        ...
        private void OperatorNote_Load(object sender, EventArgs e)
        {
            base.CloseWaitDialog();
        }
