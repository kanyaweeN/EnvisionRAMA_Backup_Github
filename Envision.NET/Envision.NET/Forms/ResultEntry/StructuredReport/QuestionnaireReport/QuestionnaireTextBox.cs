...
{
    public partial class QuestionnaireTextBox : QuestionnaireBase
    {
        private int imgBottom;
        private int imgLeft;
        private bool firstCheck;

        public QuestionnaireTextBox()
        {
            InitializeComponent();
            firstCheck = true;
        }
        public QuestionnaireTextBox(SR_QUESTIONS Question, List<SR_QUESTIONSDTL> Details, List<SR_QUESTIONSDTLCHILD> Child, bool FillAnswer, int left, int top) 
