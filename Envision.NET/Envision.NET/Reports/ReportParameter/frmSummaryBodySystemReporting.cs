...
{
    public partial class frmSummaryBodySystemReporting : MasterForm
    {
        public frmSummaryBodySystemReporting()
        {
            InitializeComponent();
        }
        ...
        private void btnGo_Click(object sender, EventArgs e)
        {
            ...
            DataSet dsData = lk.SelectACBodySystemReport(dtFrom, dtTo, RadID, Mode);
        ...
        private void frmSummaryBodySystemReporting_Load(object sender, EventArgs e)
        {
