...
using Envision.WebService.EnvisionBIService;
using System.IO;
...
{
    public partial class frmEnvisionBI : MasterForm
    {
        DateTime dateFrom;
        DateTime dateTo;
        ...
        {
            string conStr = ConfigurationSettings.AppSettings["connStrReportSearch"];
        ...
        private void btnExportExcel_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            try
            {
                ...
                {
                    gcPivotOLAP.OptionsView.ShowFilterHeaders = false;
                    gcPivotOLAP.OptionsView.ShowDataHeaders = false;

                    gcPivotOLAP.ExportToXls(saveFileDialog1.FileName);
                    
                    gcPivotOLAP.OptionsView.ShowFilterHeaders = true;
                    gcPivotOLAP.OptionsView.ShowDataHeaders = true;
                }
            }
            catch (Exception ex)
            {
        ...
        private void gvQuickTemp_DoubleClick(object sender, EventArgs e)
        {
            ...
            base.ShowWaitDialog();
            DataRow drQuick = gvQuickTemp.GetFocusedDataRow();
        ...
        private void btnEdit_Click(object sender, EventArgs e)
        {
            ...
            DataRow drQuTm = gvQuickTemp.GetFocusedDataRow();
