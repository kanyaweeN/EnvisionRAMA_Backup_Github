...
namespace TwainDotNet
{
    public class DataSourceManager : IDisposable
    {
        ...
        public event EventHandler<TransferImageIntPtrEventArgs> TransferImageIntPtr;
            ...
            try
            {
                do
                {
                    ...
                    else
                    {
                        ...
                        TransferImageIntPtrEventArgs args = new TransferImageIntPtrEventArgs(hbitmap, pendingTransfer.Count != 0);
                        TransferImageIntPtr(this, args);
                        if (!args.ContinueScanning)
                            break;
                    }
                }
