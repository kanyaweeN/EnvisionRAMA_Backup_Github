...
namespace RIS.DataAccess.Select
{
	public class MISAsessmenttypeSelectData : DataAccessBase 
	{
		...
		private MISAsessmenttypeSelectDataParameters param;
		public  MISAsessmenttypeSelectData()
		{
			StoredProcedureName = StoredProcedure.Name.Prc_MIS_ASESSMENTTYPE_Select.ToString();
		}
		...
		{
			param = new MISAsessmenttypeSelectDataParameters(MISAsessmenttype);
			DataBaseHelper dbhelper = new DataBaseHelper(StoredProcedureName);
			DataSet ds = dbhelper.Run(base.ConnectionString,param.Parameters);
			return ds;
		}
	}
	public class MISAsessmenttypeSelectDataParameters 
	{
		private MISAsessmenttype _misasessmenttype;
		private SqlParameter[] _parameters;
		public MISAsessmenttypeSelectDataParameters(MISAsessmenttype misasessmenttype)
		{
