...
namespace RIS.DataAccess.Select
{
	public class INVPrSelectData : DataAccessBase 
	{
		...
		{
			StoredProcedureName = StoredProcedure.Name.Prc_INV_PR_Select.ToString();
		}
		public  INVPr	INVPr
		{
			get{return _invpr;}
		...
		public DataSet GetData()
		{
			...
			DataSet ds = dbhelper.Run(base.ConnectionString,_invprinsertdataparameters.Parameters);
			return ds;
		}
	}
