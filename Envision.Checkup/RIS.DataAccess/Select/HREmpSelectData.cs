...
namespace RIS.DataAccess.Select
{
	public class HREmpSelectData : DataAccessBase 
	{
		...
		private HREmpSelectDataParameters param;
		public  HREmpSelectData()
		{
			StoredProcedureName = StoredProcedure.Name.Prc_HR_EMP_Select.ToString();
		}
		public  HREmp	HREmp
		{
			get{return _hremp;}
		...
		{
			param = new HREmpSelectDataParameters(HREmp);
			DataBaseHelper dbhelper = new DataBaseHelper(StoredProcedureName);
			DataSet ds = dbhelper.Run(base.ConnectionString,param.Parameters);
			return ds;
		}
	}
	public class HREmpSelectDataParameters 
	{
		private HREmp _hremp;
		private SqlParameter[] _parameters;
		public HREmpSelectDataParameters(HREmp hremp)
		{
			HREmp=hremp;
			Build();
		}
...
//,new SqlParameter("@UNIT_ID",HREmp.UNIT_ID)
...
//,new SqlParameter("@DEFAULT_LANG",HREmp.DEFAULT_LANG)
...
//,new SqlParameter("@AUTH_LEVEL_ID",HREmp.AUTH_LEVEL_ID)
...
//,new SqlParameter("@LAST_MODIFIED_ON",HREmp.LAST_MODIFIED_ON)
                new SqlParameter("@MODE",HREmp.MODE)
                ,new SqlParameter("@EMP_ID",HREmp.EMP_ID)
                ,new SqlParameter("@USER_NAME",HREmp.USER_NAME)
                ,new SqlParameter("@UNIT_ID",HREmp.UNIT_ID)
                ,new SqlParameter("@AUTH_LEVEL_ID",HREmp.AUTH_LEVEL_ID)
