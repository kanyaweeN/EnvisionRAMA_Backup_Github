...
namespace RIS.DataAccess.Insert
{
    public class InvItemInsertData : DataAccessBase
    {
        ...
        {
            this.StoredProcedureName = StoredProcedure.Name.Prc_INV_ITEM_Insert.ToString();
        }

        public void Insert()
        {
            INV_ITEM_InsertData_Parameter param = new INV_ITEM_InsertData_Parameter(common);
    ...
    public class INV_ITEM_InsertData_Parameter
    {
        SqlParameter[] sqlparam;
        INV_ITEM common;

        public INV_ITEM_InsertData_Parameter(INV_ITEM _common)
        {
            common = _common;
            Build();
        }
