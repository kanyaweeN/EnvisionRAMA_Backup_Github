...
{
    public class InvSettingsInsertData : DataAccessBase
    {
        INV_SETTINGS common;

        public InvSettingsInsertData()
        {
            this.StoredProcedureName = StoredProcedure.Name.Prc_INV_SETTINGS_Insert.ToString();
        }

        public void Insert()
        {
            InvSettingsInsertData_Parameter param = new InvSettingsInsertData_Parameter(common);
    ...
    public class InvSettingsInsertData_Parameter
    {
        SqlParameter[] sqlparam;
        INV_SETTINGS common;

        public InvSettingsInsertData_Parameter(INV_SETTINGS _common)
        {
            common = _common;
            Build();
        }
