...
namespace RIS.DataAccess.Insert
{
	public class MISBiopsyresultInsertData : DataAccessBase 
	{
		...
		private MISBiopsyresultInsertDataParameters	param;
		public  MISBiopsyresultInsertData()
		{
			StoredProcedureName = StoredProcedure.Name.Prc_MIS_BIOPSYRESULT_Insert.ToString();
		}
		...
		public bool Add()
		{
			param= new MISBiopsyresultInsertDataParameters(MISBiopsyresult);
	...
	public class MISBiopsyresultInsertDataParameters 
	{
		private MISBiopsyresult _misbiopsyresult;
		private SqlParameter[] _parameters;
		public MISBiopsyresultInsertDataParameters(MISBiopsyresult misbiopsyresult)
		{
...
,new SqlParameter("@STATUS",MISBiopsyresult.STATUS)
                //,new SqlParameter("@ASSINGED_TO",MISBiopsyresult.LAST_MODIFIED_BY)
			};
