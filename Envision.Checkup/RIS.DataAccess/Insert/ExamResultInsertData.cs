...
{
    public class ExamResultInsertData : DataAccessBase
    {
        private ExamResultSave _temp;

        private ResultInsertDataParameters _resultdataparameters;

        public ExamResultInsertData()
        {
            StoredProcedureName = StoredProcedure.Name.Prc_ExamResult_Insert.ToString();
        }

        public void Add()
        {
            _resultdataparameters = new ResultInsertDataParameters(ExamResultSave);
    ...
    public class ResultInsertDataParameters
    {
        private ExamResultSave _temp;
        private SqlParameter[] _parameters;

        public ResultInsertDataParameters(ExamResultSave template)
        {
