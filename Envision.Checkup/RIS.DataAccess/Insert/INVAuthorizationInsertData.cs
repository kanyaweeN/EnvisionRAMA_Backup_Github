...
namespace RIS.DataAccess.Insert
{
	public class INVAuthorizationInsertData : DataAccessBase 
	{
		...
		{
			StoredProcedureName = StoredProcedure.Name.Prc_INV_AUTHORIZATION_Insert.ToString();
		}
        ...
        public void Add(SqlTransaction tran)
        {
            _invauthorizationinsertdataparameters = new INVAuthorizationInsertDataParameters(INVAuthorization);
            DataBaseHelper dbhelper = new DataBaseHelper(StoredProcedureName);
            object id = dbhelper.RunScalar(tran, _invauthorizationinsertdataparameters.Parameters);
        }
	}
