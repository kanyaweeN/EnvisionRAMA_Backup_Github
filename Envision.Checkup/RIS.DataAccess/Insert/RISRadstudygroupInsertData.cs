...
namespace RIS.DataAccess.Insert
{
	public class RISRadstudygroupInsertData : DataAccessBase 
	{
		...
		private RISRadstudygroupInsertDataParameters	param;
		public  RISRadstudygroupInsertData()
		{
			StoredProcedureName = StoredProcedure.Name.Prc_RIS_RADSTUDYGROUP_Insert.ToString();
		}
		...
		public bool Add()
		{
			param= new RISRadstudygroupInsertDataParameters(RISRadstudygroup);
	...
	public class RISRadstudygroupInsertDataParameters 
	{
		private RISRadstudygroup _risradstudygroup;
		private SqlParameter[] _parameters;
		public RISRadstudygroupInsertDataParameters(RISRadstudygroup risradstudygroup)
		{
