...
{
	public class RISOpnoteitemtemplateInsertData : DataAccessBase 
	{
		...
		public  RISOpnoteitemtemplateInsertData()
		{
			StoredProcedureName = StoredProcedure.Name.Prc_RIS_OPNOTEITEMTEMPLATE_Insert.ToString();
		}
