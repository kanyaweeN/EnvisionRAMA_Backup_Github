...
namespace RIS.DataAccess.Update
{
	public class HREmpUpdateData : DataAccessBase 
	{
		...
		private HREmpUpdateDataParameters param;
		public  HREmpUpdateData()
		{
			StoredProcedureName = StoredProcedure.Name.Prc_HR_EMP_Update.ToString();
		}
		public  HREmp	HREmp
		{
			get{return _hremp;}
		...
		public bool Update()
		{
			param= new HREmpUpdateDataParameters(HREmp);
	...
	public class HREmpUpdateDataParameters 
	{
		private HREmp _hremp;
		private SqlParameter[] _parameters;
		public HREmpUpdateDataParameters(HREmp hremp)
		{
			HREmp=hremp;
			Build();
		}
