...
{
	public class RISExamresultseverityUpdateData : DataAccessBase 
	{
		...
		public  RISExamresultseverityUpdateData()
		{
			StoredProcedureName = StoredProcedure.Name.Prc_RIS_EXAMRESULTSEVERITY_Update.ToString();
		}
