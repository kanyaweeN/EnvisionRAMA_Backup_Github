...
namespace RIS.DataAccess.Update
{
    public class PatientRegistrationUpdateData : DataAccessBase
    {
        ...
        {
            StoredProcedureName = StoredProcedure.Name.Prc_Patient_Registration_Update.ToString();
        }

        public DataSet Update()
        {
            PatientRegistrationUpdateDataParameter parameters = new PatientRegistrationUpdateDataParameter(HISRegistration);
            DataBaseHelper dbhelper = new DataBaseHelper(StoredProcedureName);
            DataSet ds = dbhelper.Run(this.ConnectionString, parameters.SqlParameter);
            return ds;
        }
    ...
    public class PatientRegistrationUpdateDataParameter
    {
        HISRegistration _hisreg;
        SqlParameter[] _parameters;

        public PatientRegistrationUpdateDataParameter(HISRegistration hisreg)
        {
            _hisreg = hisreg;
            Build();
        }
