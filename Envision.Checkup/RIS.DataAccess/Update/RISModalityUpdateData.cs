...
namespace RIS.DataAccess.Update
{
	public class RISModalityUpdateData : DataAccessBase 
	{
		...
		{
			StoredProcedureName = StoredProcedure.Name.Prc_RIS_MODALITY_Update.ToString();
		}
	...
	public class RISModalityInsertDataParameters 
	{
		...
		public void Build()
		{
			SqlParameter[] parameters ={
                ...
                //new SqlParameter("@AllProperties",RISModality.AllProperties),
                //new SqlParameter("@Visible",RISModality.Visible),
                ...
                new SqlParameter("@IS_UPDATED",RISModality.IS_UPDATED),
                new SqlParameter("@IS_DELETED",RISModality.IS_DELETED),
                new SqlParameter("@ORG_ID",RISModality.ORG_ID),
                //new SqlParameter("@CREATED_BY",RISModality.CREATED_BY),
                //new SqlParameter("@CREATED_ON",RISModality.CREATED_ON),
                new SqlParameter("@LAST_MODIFIED_BY",RISModality.LAST_MODIFIED_BY),
                //new SqlParameter("@LAST_MODIFIED_ON",RISModality.LAST_MODIFIED_ON)
            };
