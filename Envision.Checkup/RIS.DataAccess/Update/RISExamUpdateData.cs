...
namespace RIS.DataAccess.Update
{
	public class RISExamUpdateData : DataAccessBase 
	{
		...
		{
			StoredProcedureName = StoredProcedure.Name.Prc_RIS_EXAM_Update.ToString();
		}
	...
	public class RISExamInsertDataParameters 
	{
		...
		public void Build()
		{
            SqlParameter pramUnitID = new SqlParameter();
            pramUnitID.ParameterName = "@UNIT_ID";
            if (RISExam.UNIT_ID == 0)
                pramUnitID.Value = DBNull.Value;
            else
                pramUnitID.Value = RISExam.UNIT_ID;

            SqlParameter pramICD_ID = new SqlParameter();
            pramICD_ID.ParameterName = "@ICD_ID";
            if (RISExam.ICD_ID == 0)
                pramICD_ID.Value = DBNull.Value;
            else
                pramICD_ID.Value = RISExam.ICD_ID;
            ...
            {
                new SqlParameter("@EXAM_ID",RISExam.EXAM_ID),
                ...
                new SqlParameter("@UNIT_ID",RISExam.UNIT_ID),
                //pramUnitID,
                ...
                new SqlParameter("@CPT_ID",DBNull.Value),
                ...
                //new SqlParameter("@CREATED_ON",RISExam.CREATED_ON),
                new SqlParameter("@LAST_MODIFIED_BY",RISExam.LAST_MODIFIED_BY),
                //new SqlParameter("@LAST_MODIFIED_ON",RISExam.LAST_MODIFIED_ON)
