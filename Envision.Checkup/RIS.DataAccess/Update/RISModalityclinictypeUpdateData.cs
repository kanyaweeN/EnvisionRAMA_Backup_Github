...
namespace RIS.DataAccess.Update
{
	public class RISModalityclinictypeUpdateData : DataAccessBase 
	{
		...
		private RISModalityclinictypeUpdateDataParameters param;
		public  RISModalityclinictypeUpdateData()
		{
			StoredProcedureName = StoredProcedure.Name.Prc_RIS_MODALITYCLINICTYPE_Update.ToString();
		}
		...
		public bool Update()
		{
			param= new RISModalityclinictypeUpdateDataParameters(RISModalityclinictype);
	...
	public class RISModalityclinictypeUpdateDataParameters 
	{
		private RISModalityclinictype _rismodalityclinictype;
		private SqlParameter[] _parameters;
		public RISModalityclinictypeUpdateDataParameters(RISModalityclinictype rismodalityclinictype)
		{
		...
		public void Build()
		{
			SqlParameter[] parameters ={			
                ...
                ,new SqlParameter("@CLINIC_TYPE_ID_OLD",RISModalityclinictype.CLINIC_TYPE_ID_OLD)
