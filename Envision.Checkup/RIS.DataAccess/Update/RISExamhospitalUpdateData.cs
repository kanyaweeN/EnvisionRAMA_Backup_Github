...
{
	public class RISExamhospitalUpdateData : DataAccessBase 
	{
		private RISExamhospital	_risexamhospital;
		private RISExamhospitalInsertDataParameters	_risexamhospitalinsertdataparameters;
		public  RISExamhospitalUpdateData()
		{
			StoredProcedureName = StoredProcedure.Name.Prc_RIS_EXAMHOSPITAL_Update.ToString();
		}
