...
namespace RIS.Forms.Schedule
{
    ...
    public abstract class WinScheduleDatabaseSupportBase : IDisposable
    {
        ...
        /// </summary>
        protected const string SELECT_OWNERS_TEMPLATE = "SELECT RIS_MODALITY.MODALITY_ID, RIS_MODALITY.ALLPROPERTIES, VISIBLE, ([MODALITY_NAME]+' ('+convert(nvarchar,[ROOM_ID])+') - '+convert(nvarchar,count(RIS_SCHEDULE.MODALITY_ID))+' / '+convert(nvarchar,ISNULL(CASE_PER_DAY,0))) as Owner,getDate() SDATE" +
" FROM {0} LEFT OUTER JOIN RIS_SCHEDULE ON  RIS_MODALITY.MODALITY_ID = RIS_SCHEDULE.MODALITY_ID AND DATEDIFF(dd,APPOINT_DT,getdate())=0" +
" GROUP BY RIS_MODALITY.MODALITY_ID,RIS_MODALITY.ALLPROPERTIES,VISIBLE,MODALITY_NAME,ROOM_ID,CASE_PER_DAY;";
        ...
        /// </summary>
        public const string OWNERS_TABLE_NAME = "RIS_MODALITY";

        /// <summary>
        /// Defines the name of the table that contains the Appointment data.
        /// </summary>
        public const string APPOINTMENTS_TABLE_NAME = "RIS_SCHEDULE";
        ...
        protected override OleDbDataAdapter DataAdapterForAppointments
        {
            get
            {
                if (this._oleDbDataAdapterForAppointments == null)
                {
                    ...
                    //	Configure the INSERT command
                    OleDbCommand insertCommand = new OleDbCommand();
                    string commandTextTemplate = @"INSERT INTO {0}(ALLPROPERTIES, APPOINT_DT, END_DATETIME, HN, MODALITY_ID, EXAM_ID, CLINIC_TYPE, SCHEDULE_DATA, BLOCK_REASON, REF_DOC, SCHEDULE_STATUS, RATE, CREATED_BY, ORG_ID) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?); SELECT SCHEDULE_ID, ALLPROPERTIES, APPOINT_DT, END_DATETIME, HN, MODALITY_ID, EXAM_ID, CLINIC_TYPE, SCHEDULE_DATA, BLOCK_REASON, REF_DOC, SCHEDULE_STATUS, RATE, CREATED_BY, ORG_ID FROM {0} WHERE (SCHEDULE_ID = @@IDENTITY)";
                    ...
                    insertCommand.Parameters.Add(new System.Data.OleDb.OleDbParameter("StartDateTime", System.Data.OleDb.OleDbType.DBTimeStamp, 8, "APPOINT_DT"));
                    insertCommand.Parameters.Add(new System.Data.OleDb.OleDbParameter("EndDateTime", System.Data.OleDb.OleDbType.DBTimeStamp, 8, "END_DATETIME"));
                    insertCommand.Parameters.Add(new System.Data.OleDb.OleDbParameter("ScheduleData", System.Data.OleDb.OleDbType.VarChar, SUBJECT_FIELD_SIZE, "HN"));
                    ...
                    insertCommand.Parameters.Add(new System.Data.OleDb.OleDbParameter("MODALITY_ID", System.Data.OleDb.OleDbType.Integer, 4, "MODALITY_ID"));
                    insertCommand.Parameters.Add(new System.Data.OleDb.OleDbParameter("Accession", System.Data.OleDb.OleDbType.Integer, 6, "EXAM_ID"));
                    insertCommand.Parameters.Add(new System.Data.OleDb.OleDbParameter("Description", System.Data.OleDb.OleDbType.VarChar, 4, "CLINIC_TYPE"));
                    insertCommand.Parameters.Add(new System.Data.OleDb.OleDbParameter("Subject", System.Data.OleDb.OleDbType.VarChar, SUBJECT_FIELD_SIZE, "SCHEDULE_DATA"));
                    insertCommand.Parameters.Add(new System.Data.OleDb.OleDbParameter("RefFrom", System.Data.OleDb.OleDbType.VarChar, SUBJECT_FIELD_SIZE, "BLOCK_REASON"));
                    insertCommand.Parameters.Add(new System.Data.OleDb.OleDbParameter("RefDoctor", System.Data.OleDb.OleDbType.VarChar, SUBJECT_FIELD_SIZE, "REF_DOC"));
                    insertCommand.Parameters.Add(new System.Data.OleDb.OleDbParameter("ScSchedule", System.Data.OleDb.OleDbType.VarChar, SUBJECT_FIELD_SIZE, "SCHEDULE_STATUS"));
                    insertCommand.Parameters.Add(new System.Data.OleDb.OleDbParameter("ScRate", System.Data.OleDb.OleDbType.VarChar, SUBJECT_FIELD_SIZE, "RATE"));
                    ...
                    //	Configure the UPDATE command
                    OleDbCommand updateCommand = new OleDbCommand();
                    commandTextTemplate = @"UPDATE {0} SET ALLPROPERTIES = ?, APPOINT_DT = ?, END_DATETIME = ?, HN = ?, MODALITY_ID = ?, EXAM_ID = ?, CLINIC_TYPE=?, SCHEDULE_DATA=?, BLOCK_REASON=?, REF_DOC=?, RATE=?, CREATED_BY=?, ORG_ID=? WHERE (SCHEDULE_ID = ?) AND (ALLPROPERTIES = ? OR ? IS NULL AND ALLPROPERTIES IS NULL) AND (END_DATETIME = ?) AND (APPOINT_DT = ?); SELECT SCHEDULE_ID, ALLPROPERTIES, APPOINT_DT, END_DATETIME, HN, MODALITY_ID, EXAM_ID, CLINIC_TYPE, SCHEDULE_DATA, BLOCK_REASON, REF_DOC, RATE, CREATED_BY, ORG_ID FROM {0} WHERE (SCHEDULE_ID = ?)";
                    ...
                    updateCommand.Parameters.Add(new System.Data.OleDb.OleDbParameter("StartDateTime", System.Data.OleDb.OleDbType.DBTimeStamp, 8, "APPOINT_DT"));
                    updateCommand.Parameters.Add(new System.Data.OleDb.OleDbParameter("EndDateTime", System.Data.OleDb.OleDbType.DBTimeStamp, 8, "END_DATETIME"));
                    updateCommand.Parameters.Add(new System.Data.OleDb.OleDbParameter("ScheduleData", System.Data.OleDb.OleDbType.VarChar, SUBJECT_FIELD_SIZE, "HN"));
                    ...
                    updateCommand.Parameters.Add(new System.Data.OleDb.OleDbParameter("MODALITY_ID", System.Data.OleDb.OleDbType.Integer, 4, "MODALITY_ID"));
                    updateCommand.Parameters.Add(new System.Data.OleDb.OleDbParameter("Accession", System.Data.OleDb.OleDbType.VarChar, SUBJECT_FIELD_SIZE, "EXAM_ID"));
                    updateCommand.Parameters.Add(new System.Data.OleDb.OleDbParameter("Description", System.Data.OleDb.OleDbType.VarChar, 4, "CLINIC_TYPE"));
                    updateCommand.Parameters.Add(new System.Data.OleDb.OleDbParameter("Subject", System.Data.OleDb.OleDbType.VarChar, SUBJECT_FIELD_SIZE, "SCHEDULE_DATA"));
                    updateCommand.Parameters.Add(new System.Data.OleDb.OleDbParameter("RefFrom", System.Data.OleDb.OleDbType.VarChar, SUBJECT_FIELD_SIZE, "BLOCK_REASON"));
                    updateCommand.Parameters.Add(new System.Data.OleDb.OleDbParameter("RefDoctor", System.Data.OleDb.OleDbType.VarChar, SUBJECT_FIELD_SIZE, "REF_DOC"));
                    updateCommand.Parameters.Add(new System.Data.OleDb.OleDbParameter("ScRATE", System.Data.OleDb.OleDbType.VarChar, SUBJECT_FIELD_SIZE, "RATE"));
                    ...
                    updateCommand.Parameters.Add(new System.Data.OleDb.OleDbParameter("Original_SCHEDULE_ID", System.Data.OleDb.OleDbType.Integer, 4, System.Data.ParameterDirection.Input, false, ((System.Byte)(0)), ((System.Byte)(0)), "SCHEDULE_ID", System.Data.DataRowVersion.Original, null));
                    ...
                    updateCommand.Parameters.Add(new System.Data.OleDb.OleDbParameter("Original_EndDateTime", System.Data.OleDb.OleDbType.DBTimeStamp, 8, System.Data.ParameterDirection.Input, false, ((System.Byte)(0)), ((System.Byte)(0)), "END_DATETIME", System.Data.DataRowVersion.Original, null));
                    ...
                    updateCommand.Parameters.Add(new System.Data.OleDb.OleDbParameter("Original_StartDateTime", System.Data.OleDb.OleDbType.DBTimeStamp, 8, System.Data.ParameterDirection.Input, false, ((System.Byte)(0)), ((System.Byte)(0)), "APPOINT_DT", System.Data.DataRowVersion.Original, null));
                    ...
                    updateCommand.Parameters.Add(new System.Data.OleDb.OleDbParameter("Select_SCHEDULE_ID", System.Data.OleDb.OleDbType.Integer, 4, "SCHEDULE_ID"));
                    this._oleDbDataAdapterForAppointments.UpdateCommand = updateCommand;

                    //	Configure the DELETE command
                    OleDbCommand deleteCommand = new OleDbCommand();
                    commandTextTemplate = @"DELETE FROM {0} WHERE (SCHEDULE_ID = ?) AND (ALLPROPERTIES = ? OR ? IS NULL AND ALLPROPERTIES IS NULL) AND (END_DATETIME = ?) AND (MODALITY_ID = ? OR ? IS NULL AND MODALITY_ID IS NULL) AND (APPOINT_DT = ?)";
                    deleteCommand.CommandText = string.Format(commandTextTemplate, WinScheduleMSSQLServerSupport.APPOINTMENTS_TABLE_NAME);
                    deleteCommand.Connection = this.Connection;
                    deleteCommand.Parameters.Add(new System.Data.OleDb.OleDbParameter("Original_SCHEDULE_ID", System.Data.OleDb.OleDbType.Integer, 4, System.Data.ParameterDirection.Input, false, ((System.Byte)(0)), ((System.Byte)(0)), "SCHEDULE_ID", System.Data.DataRowVersion.Original, null));
                    ...
                    deleteCommand.Parameters.Add(new System.Data.OleDb.OleDbParameter("Original_EndDateTime", System.Data.OleDb.OleDbType.DBTimeStamp, 8, System.Data.ParameterDirection.Input, false, ((System.Byte)(0)), ((System.Byte)(0)), "END_DATETIME", System.Data.DataRowVersion.Original, null));
                    deleteCommand.Parameters.Add(new System.Data.OleDb.OleDbParameter("Original_MODALITY_ID", System.Data.OleDb.OleDbType.VarChar, 50, System.Data.ParameterDirection.Input, false, ((System.Byte)(0)), ((System.Byte)(0)), "MODALITY_ID", System.Data.DataRowVersion.Original, null));
                    deleteCommand.Parameters.Add(new System.Data.OleDb.OleDbParameter("Original_MODALITY_ID1", System.Data.OleDb.OleDbType.VarChar, 50, System.Data.ParameterDirection.Input, false, ((System.Byte)(0)), ((System.Byte)(0)), "MODALITY_ID", System.Data.DataRowVersion.Original, null));
                    deleteCommand.Parameters.Add(new System.Data.OleDb.OleDbParameter("Original_StartDateTime", System.Data.OleDb.OleDbType.DBTimeStamp, 8, System.Data.ParameterDirection.Input, false, ((System.Byte)(0)), ((System.Byte)(0)), "APPOINT_DT", System.Data.DataRowVersion.Original, null));
