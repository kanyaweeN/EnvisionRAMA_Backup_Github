...
{  
    public partial class frmOrders_Lite :  Form         
    {
        ...
        private void txtHN_KeyPress(object sender, KeyPressEventArgs e)
        {
            ...
            else if ((int)e.KeyChar == 13)
            {
                ...
                if (txtHN.Text.Trim().Length > 0)
                {
                    ...
                    ////if (canAccess)
                    ////{
                    ////    //#region สามารถเชื่อมต่อกับ[LabourAcc.dbf]:192.168.1.14\mr\Lacc\LACC_52\Data\LabourAcc.dbf
                    ////    //thisOrder = new order();
        ...
        private bool insertData()
        {
            ...
            try
            {
                ...
                while (count < orderManger.Count) 
                {
                    ...
                    //orderManger[count].Demographic.Department_Name = "ศูนย์ตรวจคนงานไปต่างประเทศ";
        ...
        private void fillDataToCreateOrder(order Ord) 
        {
            ...
            txtOrderDepartment.Text = "ศูนย์ตรวจคนงานต่างประเทศ";
