    ...
    public class FIN_RECEIVE
    {
        ...
        public class SelectData
        {
            ...
            public DataTable Master(DateTime from_date, DateTime to_date)
            {
                ...
                select.FINPayment.PAY_ID = 0;
                select.FINPayment.FROM_DATE = new DateTime(from_date.Year, from_date.Month, from_date.Day, 0, 0, 0);
                select.FINPayment.TO_DATE = new DateTime(to_date.Year, to_date.Month, to_date.Day, 23, 59, 59);
            ...
            {
                ProcessGetFINPayment select = new ProcessGetFINPayment();
                select.FINPayment.PAY_ID = pay_id;
            ...
            public DataTable Master(int pay_id, int order_id)
            {
                ProcessGetFINPayment select = new ProcessGetFINPayment();
                select.FINPayment.PAY_ID = pay_id;
                select.FINPayment.ORDER_ID = order_id;
            ...
            public DataTable Detail(long pay_id, int exam_id, DateTime from_date, DateTime to_date)
            {
                ...
                select.FINPaymentdtl.PAY_ID = pay_id;
                select.FINPaymentdtl.EXAM_ID = exam_id;
                select.FINPaymentdtl.FROM_DATE = new DateTime(from_date.Year, from_date.Month, from_date.Day, 0, 0, 0);
                select.FINPaymentdtl.TO_DATE = new DateTime(to_date.Year, to_date.Month, to_date.Day, 23, 59, 59);
        ...
        public class UpdateData
        {
            ...
            public void Detail(long pay_id, int exam_id, string status)
            {
                ...
                update.FINPaymentdtl.PAY_ID = pay_id;
                update.FINPaymentdtl.EXAM_ID = exam_id;
                update.FINPaymentdtl.STATUS = status;
            ...
            public void Detail(long pay_id, int exam_id, string status, int order_id)
            {
                ...
                update.FINPaymentdtl.EXAM_ID = exam_id;
                update.FINPaymentdtl.STATUS = status;
                update.FINPaymentdtl.ORDER_ID = order_id;
                                ...
                                , int org_id, int created_by, int order_id)
            {
                ...
                update.FINPaymentdtl.PAY_ID = pay_id;
                update.FINPaymentdtl.EXAM_ID = exam_id;
                update.FINPaymentdtl.ITEM_ID = item_id;
                update.FINPaymentdtl.QTY = qty;
                update.FINPaymentdtl.RATE = rate;
                update.FINPaymentdtl.DISCOUNT = discount;
                update.FINPaymentdtl.PAYABLE = payable;
                update.FINPaymentdtl.PAID = paid;
                update.FINPaymentdtl.STATUS = status;
                update.FINPaymentdtl.ORG_ID = org_id;
                update.FINPaymentdtl.CREATED_BY = created_by;
                update.FINPaymentdtl.ORDER_ID = order_id;
