...
namespace EnvisionInterface.Common.Common
{
    public class Config
    {
        ...
        public static string NMRestAPI { get { return ConfigurationManager.AppSettings["NMRestAPI"]; } }
        ...
        public static Encoding ThirdPartyEncoding { get { return Encoding.GetEncoding(Convert.ToInt32(ConfigurationManager.AppSettings["ThirdPartyEncoding"])); } }
    }
