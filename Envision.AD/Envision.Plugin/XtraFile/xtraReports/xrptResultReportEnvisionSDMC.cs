...
{
    public partial class xrptResultReportEnvisionSDMC : DevExpress.XtraReports.UI.XtraReport
    {
        private DataTable dtData;
        private string NameUser, ExName;
        private string ResultText;
        public xrptResultReportEnvisionSDMC()
        {
            InitializeComponent();
        }
        public xrptResultReportEnvisionSDMC(DataTable dt, string empName, string exName)
        {
            InitializeComponent();
        ...
        public xrptResultReportEnvisionSDMC(DataTable dt, string empName, string exName, string result_text)
        {
            InitializeComponent();
            dtData = new DataTable();
            dtData = dt;
