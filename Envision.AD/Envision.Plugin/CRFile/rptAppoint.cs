...
namespace Envision.Plugin.CRFile {
    ...
    public class rptAppoint : ReportClass {
        ...
        public override string FullResourceName {
            get {
                return "Envision.Plugin.CRFile.rptAppoint.rpt";
            }
            set {
                // Do nothing
            }
    ...
    public class CachedrptAppoint : Component, ICachedReport {
        
        public CachedrptAppoint() {
        }
