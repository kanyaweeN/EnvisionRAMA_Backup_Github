    ...
    public class DirectPrint
    {
        ...
        public void OrderEntryDirectPrint(int OrderID, int UserID,int numberOfCopy)
        {
            try
            {
                ...
                {
                    orderReport.Print();
                    if (!string.IsNullOrEmpty(orderReport.clinicalIndicationAnotherPage))
                    {
                        xrptOrderReportClinicalIndicationPage cl = new xrptOrderReportClinicalIndicationPage(orderReport.clinicalIndicationAnotherPage, OrderID);
                        cl.Print();
                    }
                }
