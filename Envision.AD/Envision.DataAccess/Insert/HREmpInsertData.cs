...
namespace Envision.DataAccess.Insert
{
	public class HREmpInsertData : DataAccessBase 
	{
		...
		{
			StoredProcedureName = StoredProcedure.Prc_HR_EMP_Insert;
		}
        public bool Add()
        {
           
            //StoredProcedureName = StoredProcedure.Prc_HR_EMP_Insert;
            //StoredProcedureName = StoredProcedure.Prc_HR_EMP_Insert_withJobTitle;
        ...
        public int AddADFromHis()
        {
            DataSet ds = new DataSet();
            StoredProcedureName = StoredProcedure.Prc_HR_EMP_AD_InsertFromHIS;
