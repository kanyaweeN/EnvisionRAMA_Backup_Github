...
{
	public class RISStudyLibraryBodyPartInsertData : DataAccessBase 
	{
        public RIS_STUDYLIBRARY RIS_STUDYLIBRARY { get; set; }
        public RISStudyLibraryBodyPartInsertData()
		{
            RIS_STUDYLIBRARY = new RIS_STUDYLIBRARY();
			StoredProcedureName = StoredProcedure.Prc_RIS_STUDYLIBRARYBODYPART_Insert;
		}
		public DataSet Add()
		{
        ...
        private DbParameter[] buildParameter()
        {
            DbParameter[] parameters ={
                ...
                Parameter("@EXAM_SKILL_ID",RIS_STUDYLIBRARY.EXAM_SKILL_ID),
