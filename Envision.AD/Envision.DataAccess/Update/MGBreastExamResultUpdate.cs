...
{
    public class MGBreastExamResultUpdate : DataAccessBase
    {
        public MG_BREASTEXAMRESULT MG_BREASTEXAMRESULT { get; set; }
        //public DbTransaction _transaction { get; set; }
        public MGBreastExamResultUpdate()
        {
            this.StoredProcedureName = StoredProcedure.Prc_MG_BREASTEXAMRESULT_UPDATE;
        }
        public void UpdateData(bool useTransaction)
        {
            this.ParameterList = this.BuildParameters();
            //if (useTransaction)
            //    this.Transaction = this._transaction;
        ...
        private DbParameter[] BuildParameters()
        {
            ...
            DbParameter[] parameters = {
                                           ...
                                           Parameter("@LAST_MODIFIED_BY", this.MG_BREASTEXAMRESULT.LAST_MODIFIED_BY),
