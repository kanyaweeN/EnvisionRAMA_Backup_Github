...
{
    public class MGBreastUSMassDetailsUpdate : DataAccessBase
    {
        public MG_BREASTUSMASSDETAILS MG_BREASTUSMASSDETAILS { get; set; }
        public MGBreastUSMassDetailsUpdate()
        {
            this.StoredProcedureName = StoredProcedure.Prc_MG_BREASTUSMASSDETAILS_UPDATE;
        }
        ...
        private DbParameter[] BuildParameters()
        {
            DbParameter[] parameters = { 
                                            ...
                                            Parameter("@SPECIAL_CASE_TPYE", this.MG_BREASTUSMASSDETAILS.SPECIAL_CASE_TYPE),
                                            ...
                                            Parameter("@LAST_MODIFIED_BY", this.MG_BREASTUSMASSDETAILS.LAST_MODIFIED_BY),
