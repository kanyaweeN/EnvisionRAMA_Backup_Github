...
namespace Envision.DataAccess.Select
{
    public class RISSearchEngineSelectData : DataAccess.DataAccessBase
    {
        ...
        public DataSet GetData()
        {
            ...
            else if (RISSearchEngine.MODE == "11")
            {
                StoredProcedureName = StoredProcedure.Prc_RIS_SEARCH_Select1_OrderBy_StudyDate;
                ParameterList = buildParameterMode1();
                //ds = ExecuteDataSet();
                ds = ExecuteDataSetReportSearch();
            }
            ...
            else if (RISSearchEngine.MODE == "33")
            {
                StoredProcedureName = StoredProcedure.Prc_RIS_SEARCH_Select3_OrderBy_StudyDate;
                ParameterList = buildParameterMode3();
                //ds = ExecuteDataSet();
                ds = ExecuteDataSetReportSearch();
            }
