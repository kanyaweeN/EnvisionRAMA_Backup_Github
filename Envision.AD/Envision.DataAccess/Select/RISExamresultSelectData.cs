...
namespace Envision.DataAccess.Select
{
    public class RISExamresultSelectData : DataAccessBase
    {
        ...
        {
            StoredProcedureName = StoredProcedure.Prc_RIS_EXAMRESULT_AD_WorkList; //this
        ...
        {
            StoredProcedureName = StoredProcedure.Prc_RIS_EXAMRESULT_CaseAmt_AD;
        ...
        {
            StoredProcedureName = StoredProcedure.Prc_RIS_EXAMRESULT_CaseAmtDetail_AD;
            ParameterList = buildParameterEmpID();
            DataSet ds = new DataSet();
            ds = ExecuteDataSet();
            return ds;
