...
{
    public partial class RiskSummaryReport : Envision.NET.Forms.Main.MasterForm
    {
        private DateTime fromDt;
        private DateTime toDt;
        public RiskSummaryReport()
        {
            InitializeComponent();
        ...
        protected void btnRunReport_Click(object sender, EventArgs e)
        {
            ...
            XtraRiskSummaryReport report = new XtraRiskSummaryReport(GetReportRiskSummaryDataSet(), toDt, fromDt);
            report.ShowPreview();
