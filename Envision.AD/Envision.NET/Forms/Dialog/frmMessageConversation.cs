    ...
    public partial class frmMessageConversation : DevExpress.XtraBars.Ribbon.RibbonForm
    {
        ...
        private void btnSaveContrast_Click(object sender, EventArgs e)
        {
            if (cmbContrastName.SelectedItem == null || cmbContrastName.EditValue.ToString() == "")
                return;
            if (cmbRoute.SelectedItem == null || cmbRoute.EditValue.ToString() == "")
                return;
            if (cmbLot.SelectedItem == null || cmbLot.EditValue.ToString() == "")
                return;
            ...
            memoMessage.Text += "Dose : " + speDose.Value.ToString("#,###.00 cc.") + "\r\n";
            memoMessage.Text += "Actual Quanlity : " + speActualQuantity.Value.ToString("#,###.00 cc.") + "\r\n";
