...
{
    public partial class MyMessageBoxBlock : Form
    {

        static MyMessageBoxBlock newMessageBox;
        ...
        {
            newMessageBox = new MyMessageBoxBlock();
        ...
        public string ShowAlertAddText(string UID, int LANGID, string addText)
        {
            bool visibleCheckBox = false;
            string textCheckBox = "";
            string btn = "";
            ...
            try
            {
                ...
                while (i < dt.Rows.Count)
                {
                    if (string.IsNullOrEmpty(addText))
                        ...
                        txtMessage = dt.Rows[i]["ALT_TEXT"].ToString() + addText;
