...
{
    [Table(Name = "dbo.GBL_USERGROUP")]
    public partial class GBL_USERGROUP : INotifyPropertyChanging, INotifyPropertyChanged
    {
        ...
        private System.Nullable<char> _GROUP_TYPE;

        private System.Nullable<int> _GROUP_HEAD;

        private string _GROUP_CONTACT_NO;
        ...
        partial void OnGROUP_TYPEChanging(System.Nullable<char> value);
        ...
        partial void OnGROUP_CONTACT_NOChanging(string value);
        ...
        [Column(Storage = "_GROUP_NAME", DbType = "NVarChar(200)")]
        ...
        [Column(Storage = "_GROUP_TYPE", DbType = "NVarChar(1)")]
        public System.Nullable<char> GROUP_TYPE
        {
            get
            {
        ...
        [Column(Storage = "_GROUP_CONTACT_NO", DbType = "NVarChar(50)")]
        public string GROUP_CONTACT_NO
        {
            get
            {
        ...
        [Association(Name = "GBL_ENV_GBL_USERGROUP", Storage = "_GBL_ENV", ThisKey = "ORG_ID", OtherKey = "ORG_ID", IsForeignKey = true)]
            ...
            set
            {
                            ...
                            || (this._GBL_ENV.HasLoadedOrAssignedValue == false)))
                {
                    ...
                    if ((previousValue != null))
                    {
                        ...
                        previousValue.GBL_USERGROUPs.Remove(this);
                    }
                    this._GBL_ENV.Entity = value;
                    if ((value != null))
                    {
                        value.GBL_USERGROUPs.Add(this);
        ...
        [Association(Name = "HR_EMP_GBL_USERGROUP", Storage = "_HR_EMP", ThisKey = "GROUP_HEAD", OtherKey = "EMP_ID", IsForeignKey = true)]
