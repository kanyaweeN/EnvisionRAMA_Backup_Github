...
{
    public class MG_BREASTUSMASSDETAILS : INotifyPropertyChanged
    {
        ...
        private string _MASS_TYPE = string.Empty;
        /// <summary>
        /// Get or set mass type
        /// </summary>
        public string MASS_TYPE
        {
            get { return _MASS_TYPE; }
            set { _MASS_TYPE = value; }
        }
        private string _MASS_CYST_TYPE = string.Empty;
        /// <summary>
        /// Get or set mass cyst type
        /// </summary>
        public string MASS_CYST_TYPE
        {
            get { return _MASS_CYST_TYPE; }
            set { _MASS_CYST_TYPE = value; }
        }
        /// <summary>
        /// Get or set mass orientation
        /// </summary>
        private string _MASS_ORIENTATION = string.Empty;
        public string MASS_ORIENTATION
        {
            get { return _MASS_ORIENTATION; }
            set { _MASS_ORIENTATION = value; }
        }
        ...
        private string _MASS_LESION_BOUNDARY = string.Empty;
        /// <summary>
        /// Get or set mass lesion boundary
        /// </summary>
        public string MASS_LESION_BOUNDARY
        {
            get { return _MASS_LESION_BOUNDARY; }
            set { _MASS_LESION_BOUNDARY = value; }
        }

        public string _MASS_ECHO_PATTERN = string.Empty;
        /// <summary>
        /// Get or set mass echo pattern
        /// </summary>
        public string MASS_ECHO_PATTERN
        {
            get { return _MASS_ECHO_PATTERN; }
            set { _MASS_ECHO_PATTERN = value; }
        }

        private string _MASS_POSTERIOR_ACOUSTIC_FEATURES = string.Empty;
        /// <summary>
        /// Get or set mass posterior acoustic features
        /// </summary>
        public string MASS_POSTERIOR_ACOUSTIC_FEATURES
        {
            get { return _MASS_POSTERIOR_ACOUSTIC_FEATURES; }
            set { _MASS_POSTERIOR_ACOUSTIC_FEATURES = value; }
        }
