...
{
    [Table(Name = "dbo.RIS_EXAMRESULTTEMPLATELOGCAPTURE")]
    public partial class RIS_EXAMRESULTTEMPLATELOGCAPTURE : INotifyPropertyChanging, INotifyPropertyChanged
    {
        ...
        public RIS_EXAMRESULTTEMPLATELOGCAPTURE()
        {
            OnCreated();
        }
