...
{
    [Table(Name = "dbo.GBL_USERGROUPDTL")]
    public partial class GBL_USERGROUPDTL : INotifyPropertyChanging, INotifyPropertyChanged
    {
        ...
        [Association(Name = "GBL_ENV_GBL_USERGROUPDTL", Storage = "_GBL_ENV", ThisKey = "ORG_ID", OtherKey = "ORG_ID", IsForeignKey = true)]
            ...
            set
            {
                            ...
                            || (this._GBL_ENV.HasLoadedOrAssignedValue == false)))
                {
                    ...
                    if ((previousValue != null))
                    {
                        ...
                        previousValue.GBL_USERGROUPDTLs.Remove(this);
                    }
                    this._GBL_ENV.Entity = value;
                    if ((value != null))
                    {
                        value.GBL_USERGROUPDTLs.Add(this);
        ...
        [Association(Name = "HR_EMP_GBL_USERGROUPDTL", Storage = "_HR_EMP", ThisKey = "MEMBER_ID", OtherKey = "EMP_ID", IsForeignKey = true)]
