...
namespace EnvisionOnline.DataAccess.Select
{
    public class RISExamSelectData : DataAccessBase
    {
        ...
        {
            StoredProcedureName = StoredProcedure.Prc_RIS_EXAM_SelectONLAll;
        ...
        public DataTable InvokeOnlineAllCNMI()
        {
            ...
            dtt = ExecuteDataTableCNMI();
            return dtt;
        }
        public DataTable InvokeOnline_visible()
        {
            DataTable dtt = new DataTable();
            StoredProcedureName = StoredProcedure.Prc_RIS_EXAM_SelectONL;
            ParameterList = new DbParameter[] {
        ...
        public DataTable GetExamtypeCTorMRI(int exam_id)
        {
            DataTable dtt = new DataTable();
            StoredProcedureName = StoredProcedure.Prc_RIS_EXAMTYPE_SelectCheckCTorMRI;
            ParameterList = new DbParameter[] {
                Parameter("@EXAM_ID",exam_id)
			};
            dtt = ExecuteDataTable();
        ...
        public DataTable GetExamtypeRiskManagement(int exam_id)
        {
            DataTable dtt = new DataTable();
            StoredProcedureName = StoredProcedure.Prc_RIS_EXAMTYPE_SelectRiskManagement;
            ParameterList = new DbParameter[] {
                Parameter("@EXAM_ID",exam_id)
			};
            dtt = ExecuteDataTable();
