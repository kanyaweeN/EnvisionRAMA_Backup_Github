...
using System.Data;
using EnvisionOnline.Common.Linq;
...
namespace EnvisionOnline.DataAccess
{
    public class DataAccessBase
    {
        ...
        protected DataSet ExecuteDataSetVNA()
        {
            DataSet ds = null;
            DbCommand cmd = coreSQL.createCommand();
            if (Transaction == null)
            {
                using (DbConnection conn = coreSQL.createConnectionVNA())
                {
                    cmd.CommandText = StoredProcedureName.ToString();
                    cmd.CommandType = CommandType.StoredProcedure;
                    cmd.Connection = conn;
        ...
        protected int ExecuteNonQueryCNMI()
        {
            DbCommand cmd = coreSQL.createCommand();
            int row = -1;
            if (Transaction == null)
            {
                using (DbConnection conn = coreSQL.createConnectionCNMI())
                {
                    cmd.CommandText = StoredProcedureName.ToString();
                    cmd.CommandType = CommandType.StoredProcedure;
                    cmd.Connection = conn;
        ...
        protected DataSet ExecuteDataSetCNMI()
        {
            DataSet ds = null;
            DbCommand cmd = coreSQL.createCommand();
            if (Transaction == null)
        ...
        protected DataTable ExecuteDataTableCNMI()
        {
            DataTable data = null;
            DbCommand cmd = coreSQL.createCommand();
            if (Transaction == null)
...
namespace Envision.CoreSQL
{
    ...
    class EnvisionSQL
    {
        ...
        public DbConnection createConnectionVNA()
        {
            SqlConnection conn = new SqlConnection(Config.VNAConnectionString);
            return conn;
        }
        public DbConnection createConnectionCNMI()
        {
            SqlConnection conn = new SqlConnection(Config.CNMIConnectionString);
            return conn;
        }
