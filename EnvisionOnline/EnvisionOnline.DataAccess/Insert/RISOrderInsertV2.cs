...
namespace EnvisionOnline.DataAccess.Insert
{
    public class RISOrderInsertV2 : DataAccessBase
    {
        ...
        public RISOrderInsertV2()
        {
            ...
            StoredProcedureName = StoredProcedure.Prc_RIS_ORDER_InsertDirectOnline;
        }
        ...
        private DbParameter[] buildParameter()
        {
            ...
            if (RIS_ORDER.IS_TELEMED == null)
                pIS_TELEMED.Value = DBNull.Value;
            else
                pIS_TELEMED.Value = RIS_ORDER.IS_TELEMED == string.Empty ? (object)DBNull.Value : RIS_ORDER.IS_TELEMED;
