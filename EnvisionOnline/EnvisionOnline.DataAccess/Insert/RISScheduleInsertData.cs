...
namespace EnvisionOnline.DataAccess.Insert
{
	public class RISScheduleInsertData : DataAccessBase 
	{
        ...
        public RISScheduleInsertData()
		{
            ...
            //StoredProcedureName = StoredProcedure.Prc_RIS_SCHEDULE_Online_Insert2;
		}
        ...
        public bool AddCNMI()
        {
            StoredProcedureName = StoredProcedure.Prc_RIS_SCHEDULE_Online_Insert_FromRama;
            ParameterList = buildParameterCNMI();
            DataSet ds = new DataSet();
        ...
        private DbParameter[] buildParameter() {
            ...
            if (RIS_SCHEDULE.IS_TELEMED == null)
                pIS_TELEMED.Value = DBNull.Value;
            else
                pIS_TELEMED.Value = RIS_SCHEDULE.IS_TELEMED == string.Empty ? (object)DBNull.Value : RIS_SCHEDULE.IS_TELEMED;
        ...
        private DbParameter[] buildParameterCNMI()
        {
            DbParameter param = Parameter();
            param.ParameterName = "@SCHEDULE_ID";
            param.Direction = ParameterDirection.Output;
            ...
            DbParameter paramREF_UNIT = Parameter();
            paramREF_UNIT.ParameterName = "@REF_UNIT";
            if (RIS_SCHEDULE.REF_UNIT != 0)
                paramREF_UNIT.Value = RIS_SCHEDULE.REF_UNIT;
            else
                paramREF_UNIT.Value = DBNull.Value;

            DbParameter paramREF_DOC = Parameter();
            paramREF_DOC.ParameterName = "@REF_DOC";
            if (RIS_SCHEDULE.REF_DOC != 0)
                paramREF_DOC.Value = RIS_SCHEDULE.REF_DOC;
            else
                paramREF_DOC.Value = DBNull.Value;
