<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="normalPageAllExamGroup.aspx.cs" Inherits="normalPageAllExamGroup" %>
	...
	<telerik:RadAjaxManager ID="RadAjaxManager1" runat="server" OnAjaxRequest="RadAjaxManager1_AjaxRequest">
        <AjaxSettings>
            <telerik:AjaxSetting AjaxControlID="RadAjaxManager1">
                <UpdatedControls>
                    <telerik:AjaxUpdatedControl ControlID="grdGroupType" />
                    <telerik:AjaxUpdatedControl ControlID="RadTabStrip1" />
                    <telerik:AjaxUpdatedControl ControlID="grdExam" LoadingPanelID="RadAjaxLoadingPanel1" />
                </UpdatedControls>
            </telerik:AjaxSetting>
            <telerik:AjaxSetting AjaxControlID="grdGroupType">
                <UpdatedControls>
                    <telerik:AjaxUpdatedControl ControlID="grdGroupType" />
                    <telerik:AjaxUpdatedControl ControlID="grdExam" LoadingPanelID="RadAjaxLoadingPanel1" />
                </UpdatedControls>
            ...
            <telerik:AjaxSetting AjaxControlID="RadTabStrip1">
                <UpdatedControls>
                    <telerik:AjaxUpdatedControl ControlID="RadTabStrip1" />
                    <telerik:AjaxUpdatedControl ControlID="grdGroupType" LoadingPanelID="RadAjaxLoadingPanel1" />
                    <telerik:AjaxUpdatedControl ControlID="grdExam" LoadingPanelID="RadAjaxLoadingPanel1" />
                </UpdatedControls>
            </telerik:AjaxSetting>
        </AjaxSettings>
                ...
                <td valign="top">
                    ...
                    <telerik:RadGrid ID="grdGroupType" runat="server" PageSize="15" Height="441px" ShowStatusBar="false"
                        ...
                        <MasterTableView AutoGenerateColumns="false" TableLayout="Fixed"
                            ClientDataKeyNames="GTYPE_ID" DataKeyNames="GTYPE_ID" ShowHeader="false">
                            <Columns>
                                ...
                                <telerik:GridBoundColumn DataField="GTYPE_TEXT" HeaderText="Group Type" SortExpression="GTYPE_TEXT" HeaderStyle-BackColor="#4b6c9e" HeaderStyle-ForeColor="White"
