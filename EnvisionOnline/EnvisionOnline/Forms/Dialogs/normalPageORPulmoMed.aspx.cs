...
public partial class normalPageORPulmoMed : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        {
            checkIsValue();
            List<string> ListPageOR = new List<string>();
        }
    ...
    protected void chekbox_CheckedChanged(object sender, EventArgs e)
    {
        ...
        List<string> ListPageOR = Session["ListExamDtl"] as List<string>;
        if (clickedButton.Checked)
        {
            addExamDetail(clickedButton.Value);
            ListPageOR.Add(clickedButton.Value);
        }
        else
        {
            removeExamDetail(clickedButton.Value);
            ListPageOR.Remove(clickedButton.Value);
        }
    }
