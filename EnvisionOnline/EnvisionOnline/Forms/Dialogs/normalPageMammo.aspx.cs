...
public partial class normalPageMammo : System.Web.UI.Page 
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        { 
            checkIsValue();
            List<string> ListPageMammo = new List<string>();
        }
    ...
    protected void chekbox_CheckedChanged(object sender, EventArgs e)
    {
        ...
        List<string> ListPageMammo = Session["ListExamDtl"] as List<string>;
        if (clickedButton.Checked)
        {
            ...
            //        ListPageMammo.Add(clickedButton.Value);
            //    }
            //}
            //catch
            //{
        ...
        else
        {
            ...
            ListPageMammo.Remove(clickedButton.Value);
        }
    }
