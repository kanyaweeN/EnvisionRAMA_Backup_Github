...
public partial class normalPageCRChestAndAbdomen : System.Web.UI.Page 
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        {
            checkIsValue();
            List<string> ListPageCRChestAndAbdomen = new List<string>();
        }  
    }
    ...
    protected void chekbox_CheckedChanged(object sender, EventArgs e)
    {
        ...
        List<string> ListPageCRChestAndAbdomen = Session["ListExamDtl"] as List<string>;
        if (clickedButton.Checked)
        {
            addExamDetail(clickedButton.Value);
            ListPageCRChestAndAbdomen.Add(clickedButton.Value);
        }
        else
        {
            removeExamDetail(clickedButton.Value);
            ListPageCRChestAndAbdomen.Remove(clickedButton.Value);
        }
    }
