...
public partial class normalPageCRLowerExtremity : System.Web.UI.Page 
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        {
            checkIsValue();
            List<string> ListPageCRLowerExtremity = new List<string>();
        }
    ...
    protected void chekbox_CheckedChanged(object sender, EventArgs e)
    {
        ...
        List<string> ListPageCRLowerExtremity = Session["ListExamDtl"] as List<string>;
        if (clickedButton.Checked)
        {
            ...
            //        ListPageCRLowerExtremity.Add(clickedButton.Value);
            //    }
            //}
            //catch
            //{
        ...
        else
        {
            ...
            ListPageCRLowerExtremity.Remove(clickedButton.Value);
        }
    }
