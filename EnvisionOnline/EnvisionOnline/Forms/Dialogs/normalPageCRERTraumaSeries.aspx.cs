...
public partial class normalPageERTraumaSeries : System.Web.UI.Page 
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        {
            checkIsValue();
            List<string> ListPageCRERTraumaSeries = new List<string>();
        }     
    }
    ...
    protected void chekbox_CheckedChanged(object sender, EventArgs e)
    {
        ...
        List<string> ListPageCRERTraumaSeries = Session["ListExamDtl"] as List<string>;
        if (clickedButton.Checked)
        {
            ...
            //        ListPageCRERTraumaSeries.Add(clickedButton.Value);
            //    }
            //}
            //catch
            //{
        ...
        else
        {
            ...
            ListPageCRERTraumaSeries.Remove(clickedButton.Value);
        }
    }
