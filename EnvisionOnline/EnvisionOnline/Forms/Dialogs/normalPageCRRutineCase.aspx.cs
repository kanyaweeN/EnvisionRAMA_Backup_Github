...
public partial class normalPageCRRutineCase : System.Web.UI.Page 
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        {
            checkIsValue();
            List<string> ListPageCRRutineCase = new List<string>();
        }
    }
    ...
    protected void chekbox_CheckedChanged(object sender, EventArgs e)
    {
        ...
        List<string> ListPageCRRutineCase = Session["ListExamDtl"] as List<string>;
        if (clickedButton.Checked)
        {
            ...
            //        ListPageCRRutineCase.Add(clickedButton.Value);
            //    }
            //}
            //catch
            //{
        ...
        else
        {
            ...
            ListPageCRRutineCase.Remove(clickedButton.Value);
        }
    }
