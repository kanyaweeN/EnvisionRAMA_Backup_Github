...
public partial class normalPageCTA : System.Web.UI.Page 
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        {
            checkIsValue();
            List<string> ListPageCTA = new List<string>();
        }
    ...
    protected void chekbox_CheckedChanged(object sender, EventArgs e)
    {
        ...
        List<string> ListPageCTA = Session["ListExamDtl"] as List<string>;
        if (clickedButton.Checked)
        {
            ...
            //        ListPageCTA.Add(clickedButton.Value);
            //    }
            //}
            //catch
            //{
        ...
        else
        {
            ...
            ListPageCTA.Remove(clickedButton.Value);
        }
    }
