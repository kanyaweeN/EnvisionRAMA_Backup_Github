...
public partial class normalPageMRI : System.Web.UI.Page 
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        {
            checkIsValue();
            List<string> ListPageMRI = new List<string>();
        }
    ...
    protected void chekbox_CheckedChanged(object sender, EventArgs e)
    {
        ...
        List<string> ListPageMRI = Session["ListExamDtl"] as List<string>;
        if (clickedButton.Checked)
        {
            addExamDetail(clickedButton.Value);
            ListPageMRI.Add(clickedButton.Value);
        }
        else
        {
            removeExamDetail(clickedButton.Value);
            ListPageMRI.Remove(clickedButton.Value);
        }
    }
