<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="dialogGroupExamTypeEdit.aspx.cs" Inherits="dialogGroupExamTypeEdit" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
	<title>Edit Group Exam</title>
	    ...
	    <div>
            <table width="100%" style="border-style: none; border-width: thin; padding: 0px; margin: 0px; border-spacing: 0px" align="center">
                 <tr valign="top" class="nottarget">
                    <td colspan="2">
                        <telerik:RadComboBox ID="cmbDept" runat="server"
                ...
                <tr valign="top" class="nottarget">
                    <td>
                        <asp:Label ID="lblGroupExamType" runat="server">Exam Group : </asp:Label>
                    </td>
                    <td>
                        <asp:TextBox ID="txtGroupExamType" runat="server"></asp:TextBox>
                    </td>
                </tr>
                <tr>
                    <td>
                    ...
                    <td>
                        <asp:Button ID="btnCancle" runat="server" Text="Close" OnClick="btnCancle_Click" />
                    </td>
                </tr>
            </table>
        </div>
