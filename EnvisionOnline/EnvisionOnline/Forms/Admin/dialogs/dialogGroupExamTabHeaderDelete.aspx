<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="dialogGroupExamTabHeaderDelete.aspx.cs" Inherits="dialogGroupExamTabHeaderDelete" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
	<title>Delete Tab Header</title>
        ...
        <div>
            <table width="100%" style="border-style: none; border-width: thin; padding: 0px; margin: 0px; border-spacing: 0px" align="center">
                 <tr valign="top" class="nottarget">
                    <td colspan="2">
                        <asp:Label ID="lblTabHeader" runat="server">Do you want to delete? </asp:Label>
                    </td>
                </tr>
                <tr>
                    <td>
