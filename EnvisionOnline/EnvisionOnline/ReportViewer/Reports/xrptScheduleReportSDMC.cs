...
namespace EnvisionOnline.Operational.XtraReport.xtraReports
{
    public partial class xrptScheduleReportSDMC : DevExpress.XtraReports.UI.XtraReport
    {
        ...
        public xrptScheduleReportSDMC(GBLEnvVariable envv)
        {
            InitializeComponent();
            this.PrintingSystem.ShowMarginsWarning = false;

        }
        public xrptScheduleReportSDMC(int _schedule_id,int _org_id,string _printor_name)
        {
        ...
        public xrptScheduleReportSDMC(DataSet ds, GBLEnvVariable envv)
        {
            InitializeComponent();
            this.PrintingSystem.ShowMarginsWarning = false;
            dsTemp = new DataSet();
