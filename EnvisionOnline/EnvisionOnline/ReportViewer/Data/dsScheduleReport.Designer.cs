...
namespace EnvisionOnline.ReportViewer.Data {
    ...
    public partial class dsScheduleReport : global::System.Data.DataSet {
        ...
        private global::System.Data.DataRelation relationFK_HR_UNIT_GBL_ENV;
        ...
        internal void InitVars(bool initTable) {
            ...
            this.relationFK_HR_UNIT_GBL_ENV = this.Relations["FK_HR_UNIT_GBL_ENV"];
        }
        ...
        private void InitClass() {
            ...
            this.relationFK_HR_UNIT_GBL_ENV = new global::System.Data.DataRelation("FK_HR_UNIT_GBL_ENV", new global::System.Data.DataColumn[] {
                        this.tableGBL_ENV.ORG_IDColumn}, new global::System.Data.DataColumn[] {
                        this.tabledataSchedule.ORG_IDColumn}, false);
            this.Relations.Add(this.relationFK_HR_UNIT_GBL_ENV);
        }
        ...
        public partial class dataScheduleDataTable : global::System.Data.TypedTableBase<dataScheduleRow> {
            ...
            public dataScheduleRow AdddataScheduleRow(
                        GBL_ENVRow parentGBL_ENVRowByFK_HR_UNIT_GBL_ENV, 
                        string HN, 
                ...
                object[] columnValuesArray = new object[] {
                        ...
                        ROOM_UID,
                        INSURANCE_TYPE_DESC};
                if ((parentGBL_ENVRowByFK_HR_UNIT_GBL_ENV != null)) {
                    columnValuesArray[0] = parentGBL_ENVRowByFK_HR_UNIT_GBL_ENV[0];
                }
        ...
        public partial class GBL_ENVRow : global::System.Data.DataRow {
            ...
            public dataScheduleRow[] GetdataScheduleRows() {
                if ((this.Table.ChildRelations["FK_HR_UNIT_GBL_ENV"] == null)) {
                    return new dataScheduleRow[0];
                }
                else {
                    return ((dataScheduleRow[])(base.GetChildRows(this.Table.ChildRelations["FK_HR_UNIT_GBL_ENV"])));
                }
            }
        }
        ...
        public partial class dataScheduleRow : global::System.Data.DataRow {
            ...
            public GBL_ENVRow GBL_ENVRow {
                get {
                    return ((GBL_ENVRow)(this.GetParentRow(this.Table.ParentRelations["FK_HR_UNIT_GBL_ENV"])));
                }
                set {
                    this.SetParentRow(value, this.Table.ParentRelations["FK_HR_UNIT_GBL_ENV"]);
                }
            }
...
namespace EnvisionOnline.ReportViewer.Data.dsScheduleReportTableAdapters {
...
SELECT ORG_ID, ORG_NAME, ORG_IMG, ORG_ADDR3, ORG_ADDR4, VENDOR_H2, ORG_ADDR3 + ' ' + ORG_ADDR4 AS ENV_ADDR FROM GBL_ENV WHERE (ORG_ID = @ORG_ID)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "select ORG_ID,GBL_ENV.ORG_NAME\r\n\t\t, GBL_ENV.ORG_IMG\r\n\t\t\t\t\t, GBL_ENV.ORG_ADDR3\r\n\t\t" +
                "\t\t\t, GBL_ENV.ORG_ADDR4\r\n\t\t\t\t\t, GBL_ENV.VENDOR_H2\r\n, GBL_ENV.ORG_ADDR3+\' \'+GBL_EN" +
                "V.ORG_ADDR4 as ENV_ADDR\r\n\t\t\t\t\t\r\nfrom GBL_ENV";
    ...
    public partial class dataScheduleTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[0].Connection = this.Connection;
            this._commandCollection[0].CommandText = "SELECT\t\tRIS_SCHEDULE.ORG_ID\r\n\t\t\t, HIS_REGISTRATION.HN\r\n\t\t\t, dbo.fnGetHISRegistrat" +
                "ionFullName(RIS_SCHEDULE.REG_ID,1) AS PAT_THAI_NAME\r\n\t\t\t, dbo.fnGetHISRegistrati" +
                "onFullName(RIS_SCHEDULE.REG_ID,0) AS PAT_ENG_NAME\r\n\t\t\t\t\t, HIS_REGISTRATION.PHONE" +
                ...
                "INICTYPE.CLINIC_TYPE_TEXT\r\n\t\t\t\t\t, RIS_MODALITY.MODALITY_NAME\r\n\t\t\t\t\t, dbo.fnGetEm" +
                "pThaiName(RIS_SCHEDULE.CREATED_BY) AS CREATED_BY\r\n\t\t\t\t\t, RIS_SCHEDULE.CREATED_ON" +
                "\r\n\t\t\t\t\t\r\n\t\t\t\t\t, RIS_MODALITY.MODALITY_ID\r\n\t\t\t\t\t, RIS_EXAMINSTRUCTIONS.INS_TEXT\r\n" +
                "\t\t\t\t\t, CASE isnull(datediff(yyyy, getdate(), HIS_REGISTRATION.DOB), 0) \r\n\t\t\t\t\t\t\t" +
                "\t\t\t  WHEN 0 THEN RIS_EXAMTYPE.EXAM_TYPE_INS_KID WHEN 1 THEN RIS_EXAMTYPE.EXAM_TY" +
                "PE_INS_KID WHEN 2 THEN RIS_EXAMTYPE.EXAM_TYPE_INS_KID\r\n\t\t\t\t\t\t\t\t\t\t   WHEN 3 THEN " +
                "RIS_EXAMTYPE.EXAM_TYPE_INS_KID WHEN 4 THEN RIS_EXAMTYPE.EXAM_TYPE_INS_KID WHEN 5" +
                " THEN RIS_EXAMTYPE.EXAM_TYPE_INS_KID\r\n\t\t\t\t\t\t\t\t\t\t   WHEN 6 THEN RIS_EXAMTYPE.EXAM" +
                "_TYPE_INS_KID WHEN 7 THEN RIS_EXAMTYPE.EXAM_TYPE_INS_KID WHEN 8 THEN RIS_EXAMTYP" +
                "E.EXAM_TYPE_INS_KID\r\n\t\t\t\t\t\t\t\t\t\t   WHEN 9 THEN RIS_EXAMTYPE.EXAM_TYPE_INS_KID WHE" +
                "N 10 THEN RIS_EXAMTYPE.EXAM_TYPE_INS_KID WHEN 11 THEN RIS_EXAMTYPE.EXAM_TYPE_INS" +
                "_KID\r\n\t\t\t\t\t\t\t\t\t\t   WHEN 12 THEN RIS_EXAMTYPE.EXAM_TYPE_INS_KID ELSE RIS_EXAMTYPE" +
                ".EXAM_TYPE_INS END AS EXAM_TYPE_INS\r\n\t\t\t\t\t, HR_UNIT_EXAM.UNIT_INS AS HR_UNIT_INS" +
                "\r\n\t\t\t\t\t, HR_UNIT.UNIT_NAME AS UNIT_TITLE\r\n\t\t\t\t\t, dbo.fnGetUnitUID(RIS_SCHEDULE.R" +
                "EF_UNIT) AS [UNIT_NAME]\r\n\t\t\t\t\t, \'Age : \'+dbo.fnGetAge(HIS_REGISTRATION.DOB, 1) A" +
                "S [AGE]\r\n\t\t\t\t\t, \'Gender : \'+HIS_REGISTRATION.GENDER as GENDER\r\n\t\t\t\t\t, RIS_EXAM.C" +
                "LAIMABLE_AMT\r\n\t\t\t\t\t, RIS_EXAM.NONCLAIMABLE_AMT\r\n\t\t\t\t\t, HR_ROOM.ROOM_UID\r\n\t\t\t\t\t, " +
                "dbo.fnGetInsuranceTypeName(RIS_SCHEDULE.INSURANCE_TYPE_ID) AS INSURANCE_TYPE_DES" +
                "C\r\n--SELECT     \r\nFROM         HR_ROOM INNER JOIN\r\n                      RIS_SCH" +
                "EDULE INNER JOIN\r\n                      RIS_SCHEDULEDTL ON RIS_SCHEDULE.SCHEDULE" +
                "_ID = RIS_SCHEDULEDTL.SCHEDULE_ID INNER JOIN\r\n                      RIS_EXAM ON " +
                "RIS_SCHEDULEDTL.EXAM_ID = RIS_EXAM.EXAM_ID INNER JOIN\r\n                      HIS" +
                "_REGISTRATION ON RIS_SCHEDULE.REG_ID = HIS_REGISTRATION.REG_ID LEFT OUTER JOIN\r\n" +
                "                      HR_UNIT ON RIS_SCHEDULE.REF_UNIT = HR_UNIT.UNIT_ID INNER J" +
                "OIN\r\n                      RIS_MODALITY ON RIS_SCHEDULE.MODALITY_ID = RIS_MODALI" +
                "TY.MODALITY_ID ON HR_ROOM.ROOM_ID = RIS_MODALITY.ROOM_ID LEFT OUTER JOIN\r\n      " +
                "                HR_UNIT AS HR_UNIT_EXAM ON RIS_EXAM.UNIT_ID = HR_UNIT_EXAM.UNIT_" +
                "ID LEFT OUTER JOIN\r\n                      RIS_CLINICSESSION RIGHT OUTER JOIN\r\n  " +
                "                    RIS_CLINICTYPE ON RIS_CLINICSESSION.CLINIC_TYPE_ID = RIS_CLI" +
                "NICTYPE.CLINIC_TYPE_ID ON \r\n                      RIS_SCHEDULE.SESSION_ID = RIS_" +
                "CLINICSESSION.SESSION_ID LEFT OUTER JOIN\r\n                      RIS_EXAMTYPE ON " +
                "RIS_EXAM.EXAM_TYPE = RIS_EXAMTYPE.EXAM_TYPE_ID LEFT OUTER JOIN\r\n                " +
                "      RIS_EXAMINSTRUCTIONS ON RIS_EXAM.EXAM_ID = RIS_EXAMINSTRUCTIONS.EXAM_ID";
            this._commandCollection[0].CommandType = global::System.Data.CommandType.Text;
        }
