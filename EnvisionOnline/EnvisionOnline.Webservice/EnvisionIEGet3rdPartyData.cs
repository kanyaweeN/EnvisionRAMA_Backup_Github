...
namespace EnvisionOnline.WebService
{
    ...
    public class EnvisionIEGet3rdPartyData : SoapHttpClientProtocol
    {
        ...
        public EnvisionIEGet3rdPartyData(string host)
        {
            ...
            //Url = "http://localhost:3178/Service.asmx";
        }
        ...
        [SoapDocumentMethodAttribute("http://www.miracleadvance.com/Get_TeleMedByEncIdAndType",
            RequestNamespace = "http://www.miracleadvance.com/",
            ResponseNamespace = "http://www.miracleadvance.com/",
            Use = SoapBindingUse.Literal,
            ParameterStyle = SoapParameterStyle.Wrapped)]
        ...
        {
            return (bool)(((object[])Invoke("Get_TeleMedByEncIdAndType", new object[] { data }))[0]);
        }
    }
}
