...
{
    [Table(Name = "dbo.GBL_GENERALDTL")]
    public partial class GBL_GENERALDTL : INotifyPropertyChanging, INotifyPropertyChanged
    {

        private static PropertyChangingEventArgs emptyChangingEventArgs = new PropertyChangingEventArgs(String.Empty);

        private int _GEN_DTL_ID;

        private int _GEN_ID;

        private int _LANG_ID;

        private string _GEN_TEXT;
        ...
        partial void OnGEN_DTL_IDChanging(int value);
        ...
        partial void OnGEN_TEXTChanging(string value);
        partial void OnGEN_TEXTChanged();
        ...
        [Column(Storage = "_GEN_DTL_ID", AutoSync = AutoSync.OnInsert, DbType = "Int NOT NULL IDENTITY", IsPrimaryKey = true, IsDbGenerated = true)]
        ...
        [Column(Storage = "_GEN_ID", DbType = "Int NOT NULL")]
        public int GEN_ID
        {
            get
            {
        ...
        [Column(Storage = "_GEN_TEXT", DbType = "NVarChar(300)")]
        public string GEN_TEXT
        {
            get
            {
                return this._GEN_TEXT;
            }
            set
            {
                if ((this._GEN_TEXT != value))
                {
                    this.OnGEN_TEXTChanging(value);
                    this.SendPropertyChanging();
                    this._GEN_TEXT = value;
                    this.SendPropertyChanged("GEN_TEXT");
                    this.OnGEN_TEXTChanged();
                }
            }
        }

        [Column(Storage = "_GEN_TITLE", DbType = "NVarChar(50)")]
        ...
        [Association(Name = "GBL_ENV_GBL_GENERALDTL", Storage = "_GBL_ENV", ThisKey = "ORG_ID", OtherKey = "ORG_ID", IsForeignKey = true)]
            ...
            set
            {
                            ...
                            || (this._GBL_ENV.HasLoadedOrAssignedValue == false)))
                {
                    ...
                    if ((previousValue != null))
                    {
                        ...
                        previousValue.GBL_GENERALDTLs.Remove(this);
                    }
                    this._GBL_ENV.Entity = value;
                    if ((value != null))
                    {
                        value.GBL_GENERALDTLs.Add(this);
        ...
        [Association(Name = "GBL_LANGUAGE_GBL_GENERALDTL", Storage = "_GBL_LANGUAGE", ThisKey = "LANG_ID", OtherKey = "LANG_ID", IsForeignKey = true)]
