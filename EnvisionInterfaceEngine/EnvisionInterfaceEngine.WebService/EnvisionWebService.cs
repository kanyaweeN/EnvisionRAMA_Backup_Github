...
namespace EnvisionInterfaceEngine.WebService
{
    ...
    public class EnvisionWebService : SoapHttpClientProtocol
    {
        ...
        [SoapDocumentMethodAttribute("http://www.miracleadvance.com/GetColumnsGridOrderUtitly",
            RequestNamespace = "http://www.miracleadvance.com/",
            ResponseNamespace = "http://www.miracleadvance.com/",
            Use = SoapBindingUse.Literal,
            ParameterStyle = SoapParameterStyle.Wrapped)]
        public DataSet GetColumnsGridOrderUtitly()
        {
            return (DataSet)(((object[])Invoke("GetColumnsGridOrderUtitly", new object[] { }))[0]);
        }
    }
}
