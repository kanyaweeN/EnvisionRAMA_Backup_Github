namespace Envision.Database
{
    ...
    public partial class MG_BREASTMASSDETAILS
    {
        [Key]
        [Column(Order = 0)]
        [StringLength(30)]
        ...
        [StringLength(1)]
        public string MASS_SHAPE { get; set; }
        ...
        [StringLength(1)]
        public string MASS_DENSITY_TYPE { get; set; }

        [StringLength(1)]
        public string MASS_HAS_CALCIFICATION { get; set; }
