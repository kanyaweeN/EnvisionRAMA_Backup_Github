...
namespace EnvisionOnline.Common
{
    public class ONL_PARAMETER
    {
        ...
        private string flagClose = "N";
        private string fligNotcanReqonline = "N";
        private string flagTextEditOrder = "N";
        ...
        {
            get { return flagClose; }
            set { flagClose = value; }
        }

        public string FligNotCanReqonline
        {
            get { return fligNotcanReqonline; }
            set { fligNotcanReqonline = value; }
        }

        public string FLAGTextEditOrder
        {
            get { return flagTextEditOrder; }
            set { flagTextEditOrder = value; }
        }
