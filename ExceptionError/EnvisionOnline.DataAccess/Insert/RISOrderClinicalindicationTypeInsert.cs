...
{
    public class RISOrderClinicalindicationTypeInsert: DataAccessBase
    {
        
        public RIS_ORDERCLINICALINDICATION RIS_ORDERCLINICALINDICATION { get; set; }

        public RISOrderClinicalindicationTypeInsert()
        {
            RIS_ORDERCLINICALINDICATION = new RIS_ORDERCLINICALINDICATION();
            StoredProcedureName = StoredProcedure.Prc_RIS_ORDERCLINICALINDICATIONTYPE_Insert2;
        }
        ...
        private DbParameter[] buildParameter()
        {
            ...
            DbParameter[] parameters =
		    {
				Parameter( "@ORDER_ID"	                , RIS_ORDERCLINICALINDICATION.ORDER_ID ) ,
                 paramSchedule,
                Parameter( "@CI_TYPE_ID"	                , RIS_ORDERCLINICALINDICATION.CI_ID ) ,
