...
import * as import9 from './home.component.ngfactory';
...
class HomeModuleInjector extends import0.NgModuleInjector<import1.HomeModule> {
  ...
  _HomeModule_4:import1.HomeModule;
  ...
  constructor(parent:import8.Injector) {
    super(parent,[import9.HomeComponentNgFactory],([] as any[]));
  }
  ...
  get _ROUTES_7():any[] {
        if ((this.__ROUTES_7 == null)) { (this.__ROUTES_7 = [[{
          path: '',
          component: import11.HomeComponent,
          children: [
            {
              path: '',
            ...
            {
              path: 'peerreview',
              loadChildren: './pages/peerreview/peerreview.module#PeerReviewModule'
            }
  ...
  createInternal():import1.HomeModule {
    ...
    this._HomeModule_4 = new import1.HomeModule();
    return this._HomeModule_4;
  }
  getInternal(token:any,notFoundResult:any):any {
    ...
    if ((token === import1.HomeModule)) { return this._HomeModule_4; }
