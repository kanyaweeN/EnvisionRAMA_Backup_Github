...
import * as import1 from '../../../../../../src/app/home/pages/profile/profile.module';
...
import * as import9 from './profile.component.ngfactory';
import * as import10 from '@angular/core/src/i18n/tokens';
import * as import11 from '../../../../../../src/app/home/pages/profile/profile.component';
...
class ProfileModuleInjector extends import0.NgModuleInjector<import1.ProfileModule> {
  ...
  constructor(parent:import8.Injector) {
    super(parent,[import9.ProfileComponentNgFactory],([] as any[]));
  }
  ...
  get _ROUTES_7():any[] {
        if ((this.__ROUTES_7 == null)) { (this.__ROUTES_7 = [[{
          path: '',
          component: import11.ProfileComponent,
          pathMatch: 'full'
        }
    ]]); }
