...
import * as import0 from '../../../../src/app/login/login.component';
...
class View_LoginComponent_Host0 extends import1.AppView<any> {
  ...
  createInternal(rootSelector:string):import7.ComponentRef<any> {
    ...
    this._LoginComponent_0_3 = new Wrapper_LoginComponent(this.injectorGet(import8.Router,this.parentIndex),this.injectorGet(import9.ActivatedRoute,this.parentIndex));
