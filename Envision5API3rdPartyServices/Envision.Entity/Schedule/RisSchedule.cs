...
namespace Envision.Entity.Schedule
{
    public class RisSchedule
    {
        ...
        public string IsPrintConsentForm { get; set; }
        public DateTime? RequestResultDatetime { get; set; }
        public string IsAertClinicalInstruction { get; set; }
        public string ClinicalInstructionTag { get; set; }

        public ICollection<RisScheduleDtl> risScheduleDtls { get; set; }
    }
}
